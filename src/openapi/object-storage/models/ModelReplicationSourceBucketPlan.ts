 ...
 * 
 * @export
 * @interface ModelReplicationSourceBucketPlan
 */
export interface ModelReplicationSourceBucketPlan {
    /**
     * 
     * @type {ModelPlanType}
     * @memberof ModelReplicationSourceBucketPlan
     */
    type: ModelPlanType;
    /**
...
/**
 * Check if a given object implements the ModelReplicationSourceBucketPlan interface.
 */
export function instanceOfModelReplicationSourceBucketPlan(value: object): value is ModelReplicationSourceBucketPlan {
...
export function ModelReplicationSourceBucketPlanFromJSON(json: any): ModelReplicationSourceBucketPlan {
    return ModelReplicationSourceBucketPlanFromJSONTyped(json, false);
}

export function ModelReplicationSourceBucketPlanFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelReplicationSourceBucketPlan {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelReplicationSourceBucketPlanToJSON(json: any): ModelReplicationSourceBucketPlan {
    return ModelReplicationSourceBucketPlanToJSONTyped(json, false);
}

export function ModelReplicationSourceBucketPlanToJSONTyped(value?: ModelReplicationSourceBucketPlan | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
