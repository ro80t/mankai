...
import type { Error405Error } from './Error405Error';
import {
    Error405ErrorFromJSON,
    Error405ErrorFromJSONTyped,
    Error405ErrorToJSON,
    Error405ErrorToJSONTyped,
} from './Error405Error';
...
/**
 * Check if a given object implements the Error405 interface.
 */
export function instanceOfError405(value: object): value is Error405 {
    return true;
}

export function Error405FromJSON(json: any): Error405 {
    return Error405FromJSONTyped(json, false);
}

export function Error405FromJSONTyped(json: any, ignoreDiscriminator: boolean): Error405 {
    if (json == null) {
        return json;
    }
    return {
        
        'error': json['error'] == null ? undefined : Error405ErrorFromJSON(json['error']),
    };
}

export function Error405ToJSON(json: any): Error405 {
    return Error405ToJSONTyped(json, false);
}

export function Error405ToJSONTyped(value?: Error405 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'error': Error405ErrorToJSON(value['error']),
    };
}
