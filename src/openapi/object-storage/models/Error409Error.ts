 ...
 * error 409
 * @export
 * @interface Error409Error
 */
export interface Error409Error {
    /**
     * エラーコード。
     * 
     * @type {number}
     * @memberof Error409Error
     */
    code?: number;
    /**
     * エラー発生時のメッセージ内容。
...
/**
 * Check if a given object implements the Error409Error interface.
 */
export function instanceOfError409Error(value: object): value is Error409Error {
    return true;
}

export function Error409ErrorFromJSON(json: any): Error409Error {
    return Error409ErrorFromJSONTyped(json, false);
}

export function Error409ErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Error409Error {
    if (json == null) {
        return json;
    }
    return {
...
export function Error409ErrorToJSON(json: any): Error409Error {
    return Error409ErrorToJSONTyped(json, false);
}

export function Error409ErrorToJSONTyped(value?: Error409Error | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
