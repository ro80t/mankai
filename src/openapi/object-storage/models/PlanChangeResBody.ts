...
import {
    ContractSummaryFromJSON,
    ContractSummaryFromJSONTyped,
    ContractSummaryToJSON,
    ContractSummaryToJSONTyped,
 ...
 * 
 * @export
 * @interface PlanChangeResBody
 */
export interface PlanChangeResBody {
    /**
     * 
     * @type {ContractSummary}
     * @memberof PlanChangeResBody
     */
    previousContract?: ContractSummary;
    /**
     * 
     * @type {ContractSummary}
     * @memberof PlanChangeResBody
     */
    newContract?: ContractSummary;
    /**
     * 
     * @type {PlanSummary}
     * @memberof PlanChangeResBody
...
/**
 * Check if a given object implements the PlanChangeResBody interface.
 */
export function instanceOfPlanChangeResBody(value: object): value is PlanChangeResBody {
    return true;
}

export function PlanChangeResBodyFromJSON(json: any): PlanChangeResBody {
    return PlanChangeResBodyFromJSONTyped(json, false);
}

export function PlanChangeResBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanChangeResBody {
    if (json == null) {
        return json;
    }
    return {
        
        'previousContract': json['previous_contract'] == null ? undefined : ContractSummaryFromJSON(json['previous_contract']),
        'newContract': json['new_contract'] == null ? undefined : ContractSummaryFromJSON(json['new_contract']),
        'plan': json['plan'] == null ? undefined : PlanSummaryFromJSON(json['plan']),
    };
}

export function PlanChangeResBodyToJSON(json: any): PlanChangeResBody {
    return PlanChangeResBodyToJSONTyped(json, false);
}

export function PlanChangeResBodyToJSONTyped(value?: PlanChangeResBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'previous_contract': ContractSummaryToJSON(value['previousContract']),
        'new_contract': ContractSummaryToJSON(value['newContract']),
