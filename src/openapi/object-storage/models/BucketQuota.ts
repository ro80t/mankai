...
import type { BucketQuotaData } from './BucketQuotaData';
import {
    BucketQuotaDataFromJSON,
    BucketQuotaDataFromJSONTyped,
    BucketQuotaDataToJSON,
    BucketQuotaDataToJSONTyped,
} from './BucketQuotaData';
...
export interface BucketQuota {
    /**
     * 
     * @type {BucketQuotaData}
     * @memberof BucketQuota
     */
    data: BucketQuotaData;
}

/**
 * Check if a given object implements the BucketQuota interface.
 */
export function instanceOfBucketQuota(value: object): value is BucketQuota {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function BucketQuotaFromJSON(json: any): BucketQuota {
    return BucketQuotaFromJSONTyped(json, false);
}

export function BucketQuotaFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketQuota {
    if (json == null) {
        return json;
    }
    return {
        
        'data': BucketQuotaDataFromJSON(json['data']),
    };
}

export function BucketQuotaToJSON(json: any): BucketQuota {
    return BucketQuotaToJSONTyped(json, false);
}

export function BucketQuotaToJSONTyped(value?: BucketQuota | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': BucketQuotaDataToJSON(value['data']),
    };
}
