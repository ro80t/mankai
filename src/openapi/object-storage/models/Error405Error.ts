 ...
 * error 405
 * @export
 * @interface Error405Error
 */
export interface Error405Error {
    /**
     * エラーコード。
     * 
     * @type {number}
     * @memberof Error405Error
     */
    code?: number;
    /**
     * エラー発生時のメッセージ内容。
...
/**
 * Check if a given object implements the Error405Error interface.
 */
export function instanceOfError405Error(value: object): value is Error405Error {
    return true;
}

export function Error405ErrorFromJSON(json: any): Error405Error {
    return Error405ErrorFromJSONTyped(json, false);
}

export function Error405ErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Error405Error {
    if (json == null) {
        return json;
    }
    return {
...
export function Error405ErrorToJSON(json: any): Error405Error {
    return Error405ErrorToJSONTyped(json, false);
}

export function Error405ErrorToJSONTyped(value?: Error405Error | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
