...
import type { ErrorDefaultError } from './ErrorDefaultError';
import {
    ErrorDefaultErrorFromJSON,
    ErrorDefaultErrorFromJSONTyped,
    ErrorDefaultErrorToJSON,
    ErrorDefaultErrorToJSONTyped,
} from './ErrorDefaultError';
...
export interface ErrorDefault {
    /**
     * 
     * @type {ErrorDefaultError}
     * @memberof ErrorDefault
     */
    error?: ErrorDefaultError;
}

/**
 * Check if a given object implements the ErrorDefault interface.
 */
export function instanceOfErrorDefault(value: object): value is ErrorDefault {
    return true;
}

export function ErrorDefaultFromJSON(json: any): ErrorDefault {
    return ErrorDefaultFromJSONTyped(json, false);
}

export function ErrorDefaultFromJSONTyped(json: any, ignoreDiscriminator: boolean): ErrorDefault {
    if (json == null) {
        return json;
    }
    return {
        
        'error': json['error'] == null ? undefined : ErrorDefaultErrorFromJSON(json['error']),
    };
}

export function ErrorDefaultToJSON(json: any): ErrorDefault {
    return ErrorDefaultToJSONTyped(json, false);
}

export function ErrorDefaultToJSONTyped(value?: ErrorDefault | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'error': ErrorDefaultErrorToJSON(value['error']),
    };
}
