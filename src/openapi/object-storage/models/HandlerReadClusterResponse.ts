 ...
 * 
 * @export
 * @interface HandlerReadClusterResponse
 */
export interface HandlerReadClusterResponse {
    /**
     * 
     * @type {ClusterResponseBody}
     * @memberof HandlerReadClusterResponse
     */
    data: ClusterResponseBody;
}

/**
 * Check if a given object implements the HandlerReadClusterResponse interface.
 */
export function instanceOfHandlerReadClusterResponse(value: object): value is HandlerReadClusterResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerReadClusterResponseFromJSON(json: any): HandlerReadClusterResponse {
    return HandlerReadClusterResponseFromJSONTyped(json, false);
}

export function HandlerReadClusterResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerReadClusterResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ClusterResponseBodyFromJSON(json['data']),
    };
}

export function HandlerReadClusterResponseToJSON(json: any): HandlerReadClusterResponse {
    return HandlerReadClusterResponseToJSONTyped(json, false);
}

export function HandlerReadClusterResponseToJSONTyped(value?: HandlerReadClusterResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ClusterResponseBodyToJSON(value['data']),
    };
}
