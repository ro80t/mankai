...
import type { PlanWithContract } from './PlanWithContract';
import {
    PlanWithContractFromJSON,
    PlanWithContractFromJSONTyped,
    PlanWithContractToJSON,
    PlanWithContractToJSONTyped,
} from './PlanWithContract';

/**
 * 
 * @export
 * @interface ReadBucketPlan200Response
 */
export interface ReadBucketPlan200Response {
    /**
     * 
     * @type {PlanWithContract}
     * @memberof ReadBucketPlan200Response
     */
    data: PlanWithContract;
}

/**
 * Check if a given object implements the ReadBucketPlan200Response interface.
 */
export function instanceOfReadBucketPlan200Response(value: object): value is ReadBucketPlan200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ReadBucketPlan200ResponseFromJSON(json: any): ReadBucketPlan200Response {
    return ReadBucketPlan200ResponseFromJSONTyped(json, false);
}

export function ReadBucketPlan200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadBucketPlan200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': PlanWithContractFromJSON(json['data']),
    };
}

export function ReadBucketPlan200ResponseToJSON(json: any): ReadBucketPlan200Response {
    return ReadBucketPlan200ResponseToJSONTyped(json, false);
}

export function ReadBucketPlan200ResponseToJSONTyped(value?: ReadBucketPlan200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': PlanWithContractToJSON(value['data']),
    };
}
