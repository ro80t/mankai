...
import type { ModelBucketPlan } from './ModelBucketPlan';
import {
    ModelBucketPlanFromJSON,
    ModelBucketPlanFromJSONTyped,
    ModelBucketPlanToJSON,
    ModelBucketPlanToJSONTyped,
} from './ModelBucketPlan';

/**
 * 
 * @export
 * @interface BucketListResponseBody
 */
export interface BucketListResponseBody {
    /**
     * バケット名
     * @type {string}
     * @memberof BucketListResponseBody
     */
    name: string;
    /**
     * Resource ID
    ...
    /**
     * 
     * @type {ModelBucketPlan}
     * @memberof BucketListResponseBody
     */
    plan?: ModelBucketPlan;
}

/**
 * Check if a given object implements the BucketListResponseBody interface.
 */
export function instanceOfBucketListResponseBody(value: object): value is BucketListResponseBody {
...
export function BucketListResponseBodyFromJSON(json: any): BucketListResponseBody {
    return BucketListResponseBodyFromJSONTyped(json, false);
}

export function BucketListResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketListResponseBody {
    if (json == null) {
        return json;
    }
    return {
        ...
        'plan': json['plan'] == null ? undefined : ModelBucketPlanFromJSON(json['plan']),
    };
}

export function BucketListResponseBodyToJSON(json: any): BucketListResponseBody {
    return BucketListResponseBodyToJSONTyped(json, false);
}

export function BucketListResponseBodyToJSONTyped(value?: BucketListResponseBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'plan': ModelBucketPlanToJSON(value['plan']),
    };
}
