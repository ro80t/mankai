...
import type { HandlerCreateBucketRequestBodyPlan } from './HandlerCreateBucketRequestBodyPlan';
import {
    HandlerCreateBucketRequestBodyPlanFromJSON,
    HandlerCreateBucketRequestBodyPlanFromJSONTyped,
    HandlerCreateBucketRequestBodyPlanToJSON,
    HandlerCreateBucketRequestBodyPlanToJSONTyped,
} from './HandlerCreateBucketRequestBodyPlan';

/**
 * 
 * @export
 * @interface HandlerCreateBucketRequestBody
 */
export interface HandlerCreateBucketRequestBody {
    /**
     * 
     * @type {string}
     * @memberof HandlerCreateBucketRequestBody
     */
    clusterId: string;
    /**
     * 
     * @type {HandlerCreateBucketRequestBodyPlan}
     * @memberof HandlerCreateBucketRequestBody
     */
    plan?: HandlerCreateBucketRequestBodyPlan | null;
}

/**
 * Check if a given object implements the HandlerCreateBucketRequestBody interface.
 */
export function instanceOfHandlerCreateBucketRequestBody(value: object): value is HandlerCreateBucketRequestBody {
...
export function HandlerCreateBucketRequestBodyFromJSON(json: any): HandlerCreateBucketRequestBody {
    return HandlerCreateBucketRequestBodyFromJSONTyped(json, false);
}

export function HandlerCreateBucketRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerCreateBucketRequestBody {
    if (json == null) {
        return json;
    }
    return {
        ...
        'plan': json['plan'] === undefined ? undefined : json['plan'] === null ? null : HandlerCreateBucketRequestBodyPlanFromJSON(json['plan']),
    };
}

export function HandlerCreateBucketRequestBodyToJSON(json: any): HandlerCreateBucketRequestBody {
    return HandlerCreateBucketRequestBodyToJSONTyped(json, false);
}

export function HandlerCreateBucketRequestBodyToJSONTyped(value?: HandlerCreateBucketRequestBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'plan': HandlerCreateBucketRequestBodyPlanToJSON(value['plan']),
    };
}
