 ...
 * 
 * @export
 * @interface BucketControlsInner
 */
export interface BucketControlsInner {
    /**
     * バケット名
     * @type {string}
     * @memberof BucketControlsInner
     */
    bucketName: string;
    /**
...
/**
 * Check if a given object implements the BucketControlsInner interface.
 */
export function instanceOfBucketControlsInner(value: object): value is BucketControlsInner {
...
export function BucketControlsInnerFromJSON(json: any): BucketControlsInner {
    return BucketControlsInnerFromJSONTyped(json, false);
}

export function BucketControlsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketControlsInner {
    if (json == null) {
        return json;
    }
    return {
...
export function BucketControlsInnerToJSON(json: any): BucketControlsInner {
    return BucketControlsInnerToJSONTyped(json, false);
}

export function BucketControlsInnerToJSONTyped(value?: BucketControlsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
