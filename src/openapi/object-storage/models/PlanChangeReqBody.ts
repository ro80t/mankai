...
import type { PlanChangeReqBodyPreviousContract } from './PlanChangeReqBodyPreviousContract';
import {
    PlanChangeReqBodyPreviousContractFromJSON,
    PlanChangeReqBodyPreviousContractFromJSONTyped,
    PlanChangeReqBodyPreviousContractToJSON,
    PlanChangeReqBodyPreviousContractToJSONTyped,
} from './PlanChangeReqBodyPreviousContract';
import type { PlanChangeReqBodyNewPlan } from './PlanChangeReqBodyNewPlan';
import {
    PlanChangeReqBodyNewPlanFromJSON,
    PlanChangeReqBodyNewPlanFromJSONTyped,
    PlanChangeReqBodyNewPlanToJSON,
    PlanChangeReqBodyNewPlanToJSONTyped,
} from './PlanChangeReqBodyNewPlan';

/**
 * 
 * @export
 * @interface PlanChangeReqBody
 */
export interface PlanChangeReqBody {
    /**
     * 
     * @type {PlanChangeReqBodyPreviousContract}
     * @memberof PlanChangeReqBody
     */
    previousContract: PlanChangeReqBodyPreviousContract;
    /**
     * 
     * @type {PlanChangeReqBodyNewPlan}
     * @memberof PlanChangeReqBody
     */
    newPlan: PlanChangeReqBodyNewPlan;
}

/**
 * Check if a given object implements the PlanChangeReqBody interface.
 */
export function instanceOfPlanChangeReqBody(value: object): value is PlanChangeReqBody {
    if ((!('previousContract' in (value as Record<string, any>)) && !('previous_contract' in (value as Record<string, any>))) || ((value as Record<string, any>)['previousContract'] === undefined && (value as Record<string, any>)['previous_contract'] === undefined)) return false;
    if ((!('newPlan' in (value as Record<string, any>)) && !('new_plan' in (value as Record<string, any>))) || ((value as Record<string, any>)['newPlan'] === undefined && (value as Record<string, any>)['new_plan'] === undefined)) return false;
    return true;
}

export function PlanChangeReqBodyFromJSON(json: any): PlanChangeReqBody {
    return PlanChangeReqBodyFromJSONTyped(json, false);
}

export function PlanChangeReqBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanChangeReqBody {
    if (json == null) {
        return json;
    }
    return {
        
        'previousContract': PlanChangeReqBodyPreviousContractFromJSON(json['previous_contract']),
        'newPlan': PlanChangeReqBodyNewPlanFromJSON(json['new_plan']),
    };
}

export function PlanChangeReqBodyToJSON(json: any): PlanChangeReqBody {
    return PlanChangeReqBodyToJSONTyped(json, false);
}

export function PlanChangeReqBodyToJSONTyped(value?: PlanChangeReqBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'previous_contract': PlanChangeReqBodyPreviousContractToJSON(value['previousContract']),
        'new_plan': PlanChangeReqBodyNewPlanToJSON(value['newPlan']),
    };
}
