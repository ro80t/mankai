...
import type { ModelReplicationSourceBucketPlan } from './ModelReplicationSourceBucketPlan';
import {
    ModelReplicationSourceBucketPlanFromJSON,
    ModelReplicationSourceBucketPlanFromJSONTyped,
    ModelReplicationSourceBucketPlanToJSON,
    ModelReplicationSourceBucketPlanToJSONTyped,
} from './ModelReplicationSourceBucketPlan';

/**
 * Source bucket info
 * @export
 * @interface ModelReplicationSourceBucket
 */
export interface ModelReplicationSourceBucket {
    /**
     * 
     * @type {string}
     * @memberof ModelReplicationSourceBucket
     */
    name: string;
    /**
     * 
    ...
    /**
     * 
     * @type {ModelReplicationSourceBucketPlan}
     * @memberof ModelReplicationSourceBucket
     */
    plan: ModelReplicationSourceBucketPlan;
}

/**
 * Check if a given object implements the ModelReplicationSourceBucket interface.
 */
export function instanceOfModelReplicationSourceBucket(value: object): value is ModelReplicationSourceBucket {
...
export function ModelReplicationSourceBucketFromJSON(json: any): ModelReplicationSourceBucket {
    return ModelReplicationSourceBucketFromJSONTyped(json, false);
}

export function ModelReplicationSourceBucketFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelReplicationSourceBucket {
    if (json == null) {
        return json;
    }
    return {
        ...
        'plan': ModelReplicationSourceBucketPlanFromJSON(json['plan']),
    };
}

export function ModelReplicationSourceBucketToJSON(json: any): ModelReplicationSourceBucket {
    return ModelReplicationSourceBucketToJSONTyped(json, false);
}

export function ModelReplicationSourceBucketToJSONTyped(value?: ModelReplicationSourceBucket | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'plan': ModelReplicationSourceBucketPlanToJSON(value['plan']),
    };
}
