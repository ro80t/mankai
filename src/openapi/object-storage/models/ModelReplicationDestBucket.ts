 ...
 * @export
 * @interface ModelReplicationDestBucket
 */
export interface ModelReplicationDestBucket {
    /**
     * 
     * @type {string}
     * @memberof ModelReplicationDestBucket
     */
    name: string;
    /**
     * 
...
/**
 * Check if a given object implements the ModelReplicationDestBucket interface.
 */
export function instanceOfModelReplicationDestBucket(value: object): value is ModelReplicationDestBucket {
...
export function ModelReplicationDestBucketFromJSON(json: any): ModelReplicationDestBucket {
    return ModelReplicationDestBucketFromJSONTyped(json, false);
}

export function ModelReplicationDestBucketFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelReplicationDestBucket {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelReplicationDestBucketToJSON(json: any): ModelReplicationDestBucket {
    return ModelReplicationDestBucketToJSONTyped(json, false);
}

export function ModelReplicationDestBucketToJSONTyped(value?: ModelReplicationDestBucket | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
