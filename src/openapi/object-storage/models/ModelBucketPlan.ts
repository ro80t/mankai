 ...
 */
export interface ModelBucketPlan {
    /**
     * 
     * @type {ModelPlanType}
     * @memberof ModelBucketPlan
     */
    type?: ModelPlanType;
    /**
...
/**
 * Check if a given object implements the ModelBucketPlan interface.
 */
export function instanceOfModelBucketPlan(value: object): value is ModelBucketPlan {
    return true;
}

export function ModelBucketPlanFromJSON(json: any): ModelBucketPlan {
    return ModelBucketPlanFromJSONTyped(json, false);
}

export function ModelBucketPlanFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelBucketPlan {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelBucketPlanToJSON(json: any): ModelBucketPlan {
    return ModelBucketPlanToJSONTyped(json, false);
}

export function ModelBucketPlanToJSONTyped(value?: ModelBucketPlan | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
