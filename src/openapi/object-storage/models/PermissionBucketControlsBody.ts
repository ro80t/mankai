...
import type { BucketControlsBodyInner } from './BucketControlsBodyInner';
import {
    BucketControlsBodyInnerFromJSON,
    BucketControlsBodyInnerFromJSONTyped,
    BucketControlsBodyInnerToJSON,
    BucketControlsBodyInnerToJSONTyped,
} from './BucketControlsBodyInner';

/**
 * Request body for bucket controls for Permission
 * @export
 * @interface PermissionBucketControlsBody
 */
export interface PermissionBucketControlsBody {
    /**
     * Display name
     * @type {string}
     * @memberof PermissionBucketControlsBody
     */
    displayName: string;
    /**
     * Request body for bucket controls for Permission
     * @type {Array<BucketControlsBodyInner>}
     * @memberof PermissionBucketControlsBody
     */
    bucketControls: Array<BucketControlsBodyInner>;
}

/**
 * Check if a given object implements the PermissionBucketControlsBody interface.
 */
export function instanceOfPermissionBucketControlsBody(value: object): value is PermissionBucketControlsBody {
    ...
    if ((!('bucketControls' in (value as Record<string, any>)) && !('bucket_controls' in (value as Record<string, any>))) || ((value as Record<string, any>)['bucketControls'] === undefined && (value as Record<string, any>)['bucket_controls'] === undefined)) return false;
    return true;
}

export function PermissionBucketControlsBodyFromJSON(json: any): PermissionBucketControlsBody {
    return PermissionBucketControlsBodyFromJSONTyped(json, false);
}

export function PermissionBucketControlsBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PermissionBucketControlsBody {
    if (json == null) {
        return json;
    }
    return {
        ...
        'bucketControls': ((json['bucket_controls'] as Array<any>).map(BucketControlsBodyInnerFromJSON)),
    };
}

export function PermissionBucketControlsBodyToJSON(json: any): PermissionBucketControlsBody {
    return PermissionBucketControlsBodyToJSONTyped(json, false);
}

export function PermissionBucketControlsBodyToJSONTyped(value?: PermissionBucketControlsBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'bucket_controls': ((value['bucketControls'] as Array<any>).map(BucketControlsBodyInnerToJSON)),
    };
}
