...
/**
 * Check if a given object implements the AccountKeyData interface.
 */
export function instanceOfAccountKeyData(value: object): value is AccountKeyData {
...
export function AccountKeyDataFromJSON(json: any): AccountKeyData {
    return AccountKeyDataFromJSONTyped(json, false);
}

export function AccountKeyDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountKeyData {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountKeyDataToJSON(json: any): AccountKeyData {
    return AccountKeyDataToJSONTyped(json, false);
}

export function AccountKeyDataToJSONTyped(value?: AccountKeyData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
