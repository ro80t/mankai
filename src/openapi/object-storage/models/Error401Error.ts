 ...
 * error 401
 * @export
 * @interface Error401Error
 */
export interface Error401Error {
    /**
     * エラーコード。
     * 
     * @type {number}
     * @memberof Error401Error
     */
    code?: number;
    /**
     * エラー発生時のメッセージ内容。
...
/**
 * Check if a given object implements the Error401Error interface.
 */
export function instanceOfError401Error(value: object): value is Error401Error {
    return true;
}

export function Error401ErrorFromJSON(json: any): Error401Error {
    return Error401ErrorFromJSONTyped(json, false);
}

export function Error401ErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Error401Error {
    if (json == null) {
        return json;
    }
    return {
...
export function Error401ErrorToJSON(json: any): Error401Error {
    return Error401ErrorToJSONTyped(json, false);
}

export function Error401ErrorToJSONTyped(value?: Error401Error | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
