...
import type { ModelReplicationSourceBucket } from './ModelReplicationSourceBucket';
import {
    ModelReplicationSourceBucketFromJSON,
    ModelReplicationSourceBucketFromJSONTyped,
    ModelReplicationSourceBucketToJSON,
    ModelReplicationSourceBucketToJSONTyped,
} from './ModelReplicationSourceBucket';
import type { ModelReplicationDestBucket } from './ModelReplicationDestBucket';
import {
    ModelReplicationDestBucketFromJSON,
    ModelReplicationDestBucketFromJSONTyped,
    ModelReplicationDestBucketToJSON,
    ModelReplicationDestBucketToJSONTyped,
} from './ModelReplicationDestBucket';

/**
 * 
 * @export
 * @interface ModelReplication
 */
export interface ModelReplication {
    /**
     * 
     * @type {ModelReplicationSourceBucket}
     * @memberof ModelReplication
     */
    sourceBucket: ModelReplicationSourceBucket;
    /**
     * 
     * @type {ModelReplicationDestBucket}
     * @memberof ModelReplication
     */
    destBucket: ModelReplicationDestBucket;
    /**
     * creating=federation→cluster applying / created=cluster applied
     * @type {ModelReplicationConfigStatusEnum}
     * @memberof ModelReplication
     */
    configStatus: ModelReplicationConfigStatusEnum;
    /**
     * 
     * @type {Date}
     * @memberof ModelReplication
 ...
 * @export
 */
export const ModelReplicationConfigStatusEnum = {
    Creating: 'creating',
    Created: 'created'
} as const;
export type ModelReplicationConfigStatusEnum = typeof ModelReplicationConfigStatusEnum[keyof typeof ModelReplicationConfigStatusEnum];


/**
 * Check if a given object implements the ModelReplication interface.
 */
export function instanceOfModelReplication(value: object): value is ModelReplication {
    if ((!('sourceBucket' in (value as Record<string, any>)) && !('source_bucket' in (value as Record<string, any>))) || ((value as Record<string, any>)['sourceBucket'] === undefined && (value as Record<string, any>)['source_bucket'] === undefined)) return false;
    if ((!('destBucket' in (value as Record<string, any>)) && !('dest_bucket' in (value as Record<string, any>))) || ((value as Record<string, any>)['destBucket'] === undefined && (value as Record<string, any>)['dest_bucket'] === undefined)) return false;
    if ((!('configStatus' in (value as Record<string, any>)) && !('config_status' in (value as Record<string, any>))) || ((value as Record<string, any>)['configStatus'] === undefined && (value as Record<string, any>)['config_status'] === undefined)) return false;
    if ((!('createdAt' in (value as Record<string, any>)) && !('created_at' in (value as Record<string, any>))) || ((value as Record<string, any>)['createdAt'] === undefined && (value as Record<string, any>)['created_at'] === undefined)) return false;
    return true;
}

export function ModelReplicationFromJSON(json: any): ModelReplication {
    return ModelReplicationFromJSONTyped(json, false);
}

export function ModelReplicationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelReplication {
    if (json == null) {
        return json;
    }
    return {
        
        'sourceBucket': ModelReplicationSourceBucketFromJSON(json['source_bucket']),
        'destBucket': ModelReplicationDestBucketFromJSON(json['dest_bucket']),
        'configStatus': json['config_status'],
        'createdAt': (new Date(json['created_at'])),
    };
}

export function ModelReplicationToJSON(json: any): ModelReplication {
    return ModelReplicationToJSONTyped(json, false);
}

export function ModelReplicationToJSONTyped(value?: ModelReplication | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'source_bucket': ModelReplicationSourceBucketToJSON(value['sourceBucket']),
        'dest_bucket': ModelReplicationDestBucketToJSON(value['destBucket']),
