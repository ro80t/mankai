...
import {
    ...
    ErrorsInnerToJSON,
    ErrorsInnerToJSONTyped,
} from './ErrorsInner';

/**
 * error 500
 * @export
 * @interface ErrorDefaultError
 */
export interface ErrorDefaultError {
    /**
     * エラーコード。
     * 
     * @type {number}
     * @memberof ErrorDefaultError
     */
    code?: number;
    /**
     * エラー発生時のメッセージ内容。
...
/**
 * Check if a given object implements the ErrorDefaultError interface.
 */
export function instanceOfErrorDefaultError(value: object): value is ErrorDefaultError {
    return true;
}

export function ErrorDefaultErrorFromJSON(json: any): ErrorDefaultError {
    return ErrorDefaultErrorFromJSONTyped(json, false);
}

export function ErrorDefaultErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ErrorDefaultError {
    if (json == null) {
        return json;
    }
    return {
        ...
        'errors': json['errors'] == null ? undefined : ((json['errors'] as Array<any>).map(ErrorsInnerFromJSON)),
    };
}

export function ErrorDefaultErrorToJSON(json: any): ErrorDefaultError {
    return ErrorDefaultErrorToJSONTyped(json, false);
}

export function ErrorDefaultErrorToJSONTyped(value?: ErrorDefaultError | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'errors': value['errors'] == null ? undefined : ((value['errors'] as Array<any>).map(ErrorsInnerToJSON)),
    };
}
