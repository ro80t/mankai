...
import type { Error403Error } from './Error403Error';
import {
    Error403ErrorFromJSON,
    Error403ErrorFromJSONTyped,
    Error403ErrorToJSON,
    Error403ErrorToJSONTyped,
} from './Error403Error';
...
export function Error403FromJSONTyped(json: any, ignoreDiscriminator: boolean): Error403 {
    ...
    return {
        ...
        'error': json['error'] == null ? undefined : Error403ErrorFromJSON(json['error']),
    };
}
...
export function Error403ToJSONTyped(value?: Error403 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'error': Error403ErrorToJSON(value['error']),
    };
}
