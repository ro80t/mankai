 ...
 * @export
 * @interface PlanChangeReqBodyNewPlan
 */
export interface PlanChangeReqBodyNewPlan {
    /**
     * 
     * @type {ModelPlanType}
     * @memberof PlanChangeReqBodyNewPlan
     */
    type: ModelPlanType;
    /**
...
/**
 * Check if a given object implements the PlanChangeReqBodyNewPlan interface.
 */
export function instanceOfPlanChangeReqBodyNewPlan(value: object): value is PlanChangeReqBodyNewPlan {
...
export function PlanChangeReqBodyNewPlanFromJSON(json: any): PlanChangeReqBodyNewPlan {
    return PlanChangeReqBodyNewPlanFromJSONTyped(json, false);
}

export function PlanChangeReqBodyNewPlanFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanChangeReqBodyNewPlan {
    if (json == null) {
        return json;
    }
    return {
...
export function PlanChangeReqBodyNewPlanToJSON(json: any): PlanChangeReqBodyNewPlan {
    return PlanChangeReqBodyNewPlanToJSONTyped(json, false);
}

export function PlanChangeReqBodyNewPlanToJSONTyped(value?: PlanChangeReqBodyNewPlan | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
