...
import type { BucketResponseBody } from './BucketResponseBody';
import {
    BucketResponseBodyFromJSON,
    BucketResponseBodyFromJSONTyped,
    BucketResponseBodyToJSON,
    BucketResponseBodyToJSONTyped,
} from './BucketResponseBody';

/**
 * 
 * @export
 * @interface HandlerCreateBucketResponse
 */
export interface HandlerCreateBucketResponse {
    /**
     * 
     * @type {BucketResponseBody}
     * @memberof HandlerCreateBucketResponse
     */
    data: BucketResponseBody;
}

/**
 * Check if a given object implements the HandlerCreateBucketResponse interface.
 */
export function instanceOfHandlerCreateBucketResponse(value: object): value is HandlerCreateBucketResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerCreateBucketResponseFromJSON(json: any): HandlerCreateBucketResponse {
    return HandlerCreateBucketResponseFromJSONTyped(json, false);
}

export function HandlerCreateBucketResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerCreateBucketResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': BucketResponseBodyFromJSON(json['data']),
    };
}

export function HandlerCreateBucketResponseToJSON(json: any): HandlerCreateBucketResponse {
    return HandlerCreateBucketResponseToJSONTyped(json, false);
}

export function HandlerCreateBucketResponseToJSONTyped(value?: HandlerCreateBucketResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': BucketResponseBodyToJSON(value['data']),
    };
}
