...
import type { ClusterResponseBody } from './ClusterResponseBody';
import {
    ClusterResponseBodyFromJSON,
    ClusterResponseBodyFromJSONTyped,
    ClusterResponseBodyToJSON,
    ClusterResponseBodyToJSONTyped,
} from './ClusterResponseBody';

/**
 * 
 * @export
 * @interface HandlerListClustersResponse
 */
export interface HandlerListClustersResponse {
    /**
     * If use a pointer type, break output
     * @type {Array<ClusterResponseBody>}
     * @memberof HandlerListClustersResponse
     */
    data: Array<ClusterResponseBody>;
}

/**
 * Check if a given object implements the HandlerListClustersResponse interface.
 */
export function instanceOfHandlerListClustersResponse(value: object): value is HandlerListClustersResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerListClustersResponseFromJSON(json: any): HandlerListClustersResponse {
    return HandlerListClustersResponseFromJSONTyped(json, false);
}

export function HandlerListClustersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerListClustersResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(ClusterResponseBodyFromJSON)),
    };
}

export function HandlerListClustersResponseToJSON(json: any): HandlerListClustersResponse {
    return HandlerListClustersResponseToJSONTyped(json, false);
}

export function HandlerListClustersResponseToJSONTyped(value?: HandlerListClustersResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(ClusterResponseBodyToJSON)),
    };
}
