...
export function ErrorsInnerToJSON(json: any): ErrorsInner {
    return ErrorsInnerToJSONTyped(json, false);
}

export function ErrorsInnerToJSONTyped(value?: ErrorsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
