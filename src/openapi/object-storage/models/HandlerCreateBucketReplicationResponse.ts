...
import type { ModelReplication } from './ModelReplication';
import {
    ModelReplicationFromJSON,
    ModelReplicationFromJSONTyped,
    ModelReplicationToJSON,
    ModelReplicationToJSONTyped,
} from './ModelReplication';

/**
 * 
 * @export
 * @interface HandlerCreateBucketReplicationResponse
 */
export interface HandlerCreateBucketReplicationResponse {
    /**
     * 
     * @type {ModelReplication}
     * @memberof HandlerCreateBucketReplicationResponse
     */
    data: ModelReplication;
}

/**
 * Check if a given object implements the HandlerCreateBucketReplicationResponse interface.
 */
export function instanceOfHandlerCreateBucketReplicationResponse(value: object): value is HandlerCreateBucketReplicationResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerCreateBucketReplicationResponseFromJSON(json: any): HandlerCreateBucketReplicationResponse {
    return HandlerCreateBucketReplicationResponseFromJSONTyped(json, false);
}

export function HandlerCreateBucketReplicationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerCreateBucketReplicationResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ModelReplicationFromJSON(json['data']),
    };
}

export function HandlerCreateBucketReplicationResponseToJSON(json: any): HandlerCreateBucketReplicationResponse {
    return HandlerCreateBucketReplicationResponseToJSONTyped(json, false);
}

export function HandlerCreateBucketReplicationResponseToJSONTyped(value?: HandlerCreateBucketReplicationResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ModelReplicationToJSON(value['data']),
    };
}
