 ...
 * 
 * @export
 * @interface AccountKeysDataInner
 */
export interface AccountKeysDataInner {
    /**
     * Access key ID
     * @type {string}
     * @memberof AccountKeysDataInner
     */
    id: string;
    /**
     * Created at
...
/**
 * Check if a given object implements the AccountKeysDataInner interface.
 */
export function instanceOfAccountKeysDataInner(value: object): value is AccountKeysDataInner {
    if (!('id' in value) || value['id'] === undefined) return false;
    if ((!('createdAt' in (value as Record<string, any>)) && !('created_at' in (value as Record<string, any>))) || ((value as Record<string, any>)['createdAt'] === undefined && (value as Record<string, any>)['created_at'] === undefined)) return false;
    return true;
}

export function AccountKeysDataInnerFromJSON(json: any): AccountKeysDataInner {
    return AccountKeysDataInnerFromJSONTyped(json, false);
}

export function AccountKeysDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountKeysDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function AccountKeysDataInnerToJSON(json: any): AccountKeysDataInner {
    return AccountKeysDataInnerToJSONTyped(json, false);
}

export function AccountKeysDataInnerToJSONTyped(value?: AccountKeysDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
