 ...
 * 
 * @export
 * @interface CreateBucketReplicationRequest
 */
export interface CreateBucketReplicationRequest {
    /**
     * 
     * @type {string}
     * @memberof CreateBucketReplicationRequest
     */
    destBucket: string;
}

/**
 * Check if a given object implements the CreateBucketReplicationRequest interface.
 */
export function instanceOfCreateBucketReplicationRequest(value: object): value is CreateBucketReplicationRequest {
...
export function CreateBucketReplicationRequestFromJSON(json: any): CreateBucketReplicationRequest {
    return CreateBucketReplicationRequestFromJSONTyped(json, false);
}

export function CreateBucketReplicationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateBucketReplicationRequest {
    if (json == null) {
        return json;
    }
    return {
        
        'destBucket': json['dest_bucket'],
    };
}

export function CreateBucketReplicationRequestToJSON(json: any): CreateBucketReplicationRequest {
    return CreateBucketReplicationRequestToJSONTyped(json, false);
}

export function CreateBucketReplicationRequestToJSONTyped(value?: CreateBucketReplicationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
