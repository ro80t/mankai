...
import type { AccountKeysDataInner } from './AccountKeysDataInner';
import {
    AccountKeysDataInnerFromJSON,
    AccountKeysDataInnerFromJSONTyped,
    AccountKeysDataInnerToJSON,
    AccountKeysDataInnerToJSONTyped,
} from './AccountKeysDataInner';
...
export interface AccountKeys {
    /**
     * data type
     * @type {Array<AccountKeysDataInner>}
     * @memberof AccountKeys
     */
    data: Array<AccountKeysDataInner>;
}

/**
 * Check if a given object implements the AccountKeys interface.
 */
export function instanceOfAccountKeys(value: object): value is AccountKeys {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function AccountKeysFromJSON(json: any): AccountKeys {
    return AccountKeysFromJSONTyped(json, false);
}

export function AccountKeysFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountKeys {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(AccountKeysDataInnerFromJSON)),
    };
}

export function AccountKeysToJSON(json: any): AccountKeys {
    return AccountKeysToJSONTyped(json, false);
}

export function AccountKeysToJSONTyped(value?: AccountKeys | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(AccountKeysDataInnerToJSON)),
    };
}
