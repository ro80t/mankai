...
import type { Error409Error } from './Error409Error';
import {
    Error409ErrorFromJSON,
    Error409ErrorFromJSONTyped,
    Error409ErrorToJSON,
    Error409ErrorToJSONTyped,
} from './Error409Error';
...
export function Error409FromJSONTyped(json: any, ignoreDiscriminator: boolean): Error409 {
    if (json == null) {
        return json;
    }
    return {
        
        'error': json['error'] == null ? undefined : Error409ErrorFromJSON(json['error']),
    };
}
...
export function Error409ToJSONTyped(value?: Error409 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'error': Error409ErrorToJSON(value['error']),
    };
}
