...
import type { PermissionKeyCreateResponseBody } from './PermissionKeyCreateResponseBody';
import {
    PermissionKeyCreateResponseBodyFromJSON,
    PermissionKeyCreateResponseBodyFromJSONTyped,
    PermissionKeyCreateResponseBodyToJSON,
    PermissionKeyCreateResponseBodyToJSONTyped,
} from './PermissionKeyCreateResponseBody';

/**
 * 
 * @export
 * @interface HandlerCreatePermissionKeyResponse
 */
export interface HandlerCreatePermissionKeyResponse {
    /**
     * 
     * @type {PermissionKeyCreateResponseBody}
     * @memberof HandlerCreatePermissionKeyResponse
     */
    data: PermissionKeyCreateResponseBody;
}

/**
 * Check if a given object implements the HandlerCreatePermissionKeyResponse interface.
 */
export function instanceOfHandlerCreatePermissionKeyResponse(value: object): value is HandlerCreatePermissionKeyResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerCreatePermissionKeyResponseFromJSON(json: any): HandlerCreatePermissionKeyResponse {
    return HandlerCreatePermissionKeyResponseFromJSONTyped(json, false);
}

export function HandlerCreatePermissionKeyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerCreatePermissionKeyResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': PermissionKeyCreateResponseBodyFromJSON(json['data']),
    };
}

export function HandlerCreatePermissionKeyResponseToJSON(json: any): HandlerCreatePermissionKeyResponse {
    return HandlerCreatePermissionKeyResponseToJSONTyped(json, false);
}

export function HandlerCreatePermissionKeyResponseToJSONTyped(value?: HandlerCreatePermissionKeyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': PermissionKeyCreateResponseBodyToJSON(value['data']),
    };
}
