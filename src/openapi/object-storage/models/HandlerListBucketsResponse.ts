 ...
 * 
 * @export
 * @interface HandlerListBucketsResponse
 */
export interface HandlerListBucketsResponse {
    /**
     * 
     * @type {Array<BucketListResponseBody>}
     * @memberof HandlerListBucketsResponse
     */
    data: Array<BucketListResponseBody>;
}

/**
 * Check if a given object implements the HandlerListBucketsResponse interface.
 */
export function instanceOfHandlerListBucketsResponse(value: object): value is HandlerListBucketsResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerListBucketsResponseFromJSON(json: any): HandlerListBucketsResponse {
    return HandlerListBucketsResponseFromJSONTyped(json, false);
}

export function HandlerListBucketsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerListBucketsResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function HandlerListBucketsResponseToJSON(json: any): HandlerListBucketsResponse {
    return HandlerListBucketsResponseToJSONTyped(json, false);
}

export function HandlerListBucketsResponseToJSONTyped(value?: HandlerListBucketsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
