...
/**
 * Check if a given object implements the PermissionData interface.
 */
export function instanceOfPermissionData(value: object): value is PermissionData {
...
export function PermissionDataFromJSON(json: any): PermissionData {
    return PermissionDataFromJSONTyped(json, false);
}

export function PermissionDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PermissionData {
    if (json == null) {
        return json;
    }
    return {
...
export function PermissionDataToJSON(json: any): PermissionData {
    return PermissionDataToJSONTyped(json, false);
}

export function PermissionDataToJSONTyped(value?: PermissionData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
