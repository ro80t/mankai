 ...
 * 
 * @export
 * @interface PermissionKeyReadResponseBody
 */
export interface PermissionKeyReadResponseBody {
    /**
     * Permission key ID
     * @type {string}
     * @memberof PermissionKeyReadResponseBody
     */
    id: string;
    /**
     * Created at
...
/**
 * Check if a given object implements the PermissionKeyReadResponseBody interface.
 */
export function instanceOfPermissionKeyReadResponseBody(value: object): value is PermissionKeyReadResponseBody {
    if (!('id' in value) || value['id'] === undefined) return false;
    if ((!('createdAt' in (value as Record<string, any>)) && !('created_at' in (value as Record<string, any>))) || ((value as Record<string, any>)['createdAt'] === undefined && (value as Record<string, any>)['created_at'] === undefined)) return false;
    return true;
}

export function PermissionKeyReadResponseBodyFromJSON(json: any): PermissionKeyReadResponseBody {
    return PermissionKeyReadResponseBodyFromJSONTyped(json, false);
}

export function PermissionKeyReadResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PermissionKeyReadResponseBody {
    if (json == null) {
        return json;
    }
    return {
...
export function PermissionKeyReadResponseBodyToJSON(json: any): PermissionKeyReadResponseBody {
    return PermissionKeyReadResponseBodyToJSONTyped(json, false);
}

export function PermissionKeyReadResponseBodyToJSONTyped(value?: PermissionKeyReadResponseBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
