...
import type { PermissionsDataInner } from './PermissionsDataInner';
import {
    PermissionsDataInnerFromJSON,
    PermissionsDataInnerFromJSONTyped,
    PermissionsDataInnerToJSON,
    PermissionsDataInnerToJSONTyped,
} from './PermissionsDataInner';
...
export interface Permissions {
    /**
     * data type
     * @type {Array<PermissionsDataInner>}
     * @memberof Permissions
     */
    data: Array<PermissionsDataInner>;
}
...
export function PermissionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Permissions {
    ...
    return {
        ...
        'data': ((json['data'] as Array<any>).map(PermissionsDataInnerFromJSON)),
    };
}
...
export function PermissionsToJSONTyped(value?: Permissions | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PermissionsDataInnerToJSON)),
    };
}
