...
import type { PlanChangeResBody } from './PlanChangeResBody';
import {
    PlanChangeResBodyFromJSON,
    PlanChangeResBodyFromJSONTyped,
    PlanChangeResBodyToJSON,
    PlanChangeResBodyToJSONTyped,
} from './PlanChangeResBody';

/**
 * 
 * @export
 * @interface UpdateBucketPlan200Response
 */
export interface UpdateBucketPlan200Response {
    /**
     * 
     * @type {PlanChangeResBody}
     * @memberof UpdateBucketPlan200Response
     */
    data: PlanChangeResBody;
}

/**
 * Check if a given object implements the UpdateBucketPlan200Response interface.
 */
export function instanceOfUpdateBucketPlan200Response(value: object): value is UpdateBucketPlan200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function UpdateBucketPlan200ResponseFromJSON(json: any): UpdateBucketPlan200Response {
    return UpdateBucketPlan200ResponseFromJSONTyped(json, false);
}

export function UpdateBucketPlan200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateBucketPlan200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': PlanChangeResBodyFromJSON(json['data']),
    };
}

export function UpdateBucketPlan200ResponseToJSON(json: any): UpdateBucketPlan200Response {
    return UpdateBucketPlan200ResponseToJSONTyped(json, false);
}

export function UpdateBucketPlan200ResponseToJSONTyped(value?: UpdateBucketPlan200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': PlanChangeResBodyToJSON(value['data']),
    };
}
