...
import type { ReadAccountKeyData } from './ReadAccountKeyData';
import {
    ReadAccountKeyDataFromJSON,
    ReadAccountKeyDataFromJSONTyped,
    ReadAccountKeyDataToJSON,
    ReadAccountKeyDataToJSONTyped,
} from './ReadAccountKeyData';

/**
 * Root user access key
 * @export
 * @interface ReadAccountKey
 */
export interface ReadAccountKey {
    /**
     * 
     * @type {ReadAccountKeyData}
     * @memberof ReadAccountKey
     */
    data: ReadAccountKeyData;
}

/**
 * Check if a given object implements the ReadAccountKey interface.
 */
export function instanceOfReadAccountKey(value: object): value is ReadAccountKey {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ReadAccountKeyFromJSON(json: any): ReadAccountKey {
    return ReadAccountKeyFromJSONTyped(json, false);
}

export function ReadAccountKeyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadAccountKey {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ReadAccountKeyDataFromJSON(json['data']),
    };
}

export function ReadAccountKeyToJSON(json: any): ReadAccountKey {
    return ReadAccountKeyToJSONTyped(json, false);
}

export function ReadAccountKeyToJSONTyped(value?: ReadAccountKey | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ReadAccountKeyDataToJSON(value['data']),
    };
}
