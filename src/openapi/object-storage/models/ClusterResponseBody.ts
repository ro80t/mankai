 ...
 * 
 * @export
 * @interface ClusterResponseBody
 */
export interface ClusterResponseBody {
    /**
     * API Servers Zones
     * @type {Array<string>}
     * @memberof ClusterResponseBody
     */
    apiZone: Array<string>;
    /**
     ...
     * @memberof ClusterResponseBody
     */
    s3EndpointForControlPanel: string;
    /**
     * Storage Servers Zones
     * @type {Array<string>}
     * @memberof ClusterResponseBody
     */
    storageZone: Array<string>;
    /**
     * Pricing/behavior family of the cluster.
     * @type {ClusterResponseBodyPlanFamilyEnum}
     * @memberof ClusterResponseBody
     */
    planFamily: ClusterResponseBodyPlanFamilyEnum;
}
 ...
 * @export
 */
export const ClusterResponseBodyPlanFamilyEnum = {
    Standard: 'standard',
    Archive: 'archive'
} as const;
export type ClusterResponseBodyPlanFamilyEnum = typeof ClusterResponseBodyPlanFamilyEnum[keyof typeof ClusterResponseBodyPlanFamilyEnum];


/**
 * Check if a given object implements the ClusterResponseBody interface.
 */
export function instanceOfClusterResponseBody(value: object): value is ClusterResponseBody {
    if ((!('apiZone' in (value as Record<string, any>)) && !('api_zone' in (value as Record<string, any>))) || ((value as Record<string, any>)['apiZone'] === undefined && (value as Record<string, any>)['api_zone'] === undefined)) return false;
    if ((!('controlPanelUrl' in (value as Record<string, any>)) && !('control_panel_url' in (value as Record<string, any>))) || ((value as Record<string, any>)['controlPanelUrl'] === undefined && (value as Record<string, any>)['control_panel_url'] === undefined)) return false;
    if ((!('displayNameEnUs' in (value as Record<string, any>)) && !('display_name_en_us' in (value as Record<string, any>))) || ((value as Record<string, any>)['displayNameEnUs'] === undefined && (value as Record<string, any>)['display_name_en_us'] === undefined)) return false;
    if ((!('displayNameJa' in (value as Record<string, any>)) && !('display_name_ja' in (value as Record<string, any>))) || ((value as Record<string, any>)['displayNameJa'] === undefined && (value as Record<string, any>)['display_name_ja'] === undefined)) return false;
    ...
    if ((!('displayOrder' in (value as Record<string, any>)) && !('display_order' in (value as Record<string, any>))) || ((value as Record<string, any>)['displayOrder'] === undefined && (value as Record<string, any>)['display_order'] === undefined)) return false;
    if ((!('endpointBase' in (value as Record<string, any>)) && !('endpoint_base' in (value as Record<string, any>))) || ((value as Record<string, any>)['endpointBase'] === undefined && (value as Record<string, any>)['endpoint_base'] === undefined)) return false;
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('region' in value) || value['region'] === undefined) return false;
    if ((!('s3Endpoint' in (value as Record<string, any>)) && !('s3_endpoint' in (value as Record<string, any>))) || ((value as Record<string, any>)['s3Endpoint'] === undefined && (value as Record<string, any>)['s3_endpoint'] === undefined)) return false;
    if ((!('s3EndpointForControlPanel' in (value as Record<string, any>)) && !('s3_endpoint_for_control_panel' in (value as Record<string, any>))) || ((value as Record<string, any>)['s3EndpointForControlPanel'] === undefined && (value as Record<string, any>)['s3_endpoint_for_control_panel'] === undefined)) return false;
    if ((!('storageZone' in (value as Record<string, any>)) && !('storage_zone' in (value as Record<string, any>))) || ((value as Record<string, any>)['storageZone'] === undefined && (value as Record<string, any>)['storage_zone'] === undefined)) return false;
    if ((!('planFamily' in (value as Record<string, any>)) && !('plan_family' in (value as Record<string, any>))) || ((value as Record<string, any>)['planFamily'] === undefined && (value as Record<string, any>)['plan_family'] === undefined)) return false;
    return true;
}

export function ClusterResponseBodyFromJSON(json: any): ClusterResponseBody {
    return ClusterResponseBodyFromJSONTyped(json, false);
}

export function ClusterResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClusterResponseBody {
    if (json == null) {
        return json;
    }
    return {
        
        'apiZone': json['api_zone'],
        'controlPanelUrl': json['control_panel_url'],
        'displayNameEnUs': json['display_name_en_us'],
        'displayNameJa': json['display_name_ja'],
        'displayName': json['display_name'],
        'displayOrder': json['display_order'],
        'endpointBase': json['endpoint_base'],
        'id': json['id'],
        'region': json['region'],
        's3Endpoint': json['s3_endpoint'],
        's3EndpointForControlPanel': json['s3_endpoint_for_control_panel'],
        'storageZone': json['storage_zone'],
        'planFamily': json['plan_family'],
    };
}

export function ClusterResponseBodyToJSON(json: any): ClusterResponseBody {
    return ClusterResponseBodyToJSONTyped(json, false);
}

export function ClusterResponseBodyToJSONTyped(value?: ClusterResponseBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'api_zone': value['apiZone'],
        'control_panel_url': value['controlPanelUrl'],
        'display_name_en_us': value['displayNameEnUs'],
        'display_name_ja': value['displayNameJa'],
        'display_name': value['displayName'],
        'display_order': value['displayOrder'],
        'endpoint_base': value['endpointBase'],
        'id': value['id'],
        'region': value['region'],
        's3_endpoint': value['s3Endpoint'],
        's3_endpoint_for_control_panel': value['s3EndpointForControlPanel'],
        'storage_zone': value['storageZone'],
        'plan_family': value['planFamily'],
    };
}
