...
import type { BucketControlsInner } from './BucketControlsInner';
import {
    BucketControlsInnerFromJSON,
    BucketControlsInnerFromJSONTyped,
    BucketControlsInnerToJSON,
    BucketControlsInnerToJSONTyped,
} from './BucketControlsInner';

/**
 * 
 * @export
 * @interface PermissionsDataInner
 */
export interface PermissionsDataInner {
    /**
     * Permission ID
     * @type {number}
     * @memberof PermissionsDataInner
     */
    id: number;
    /**
     * Display name
    ...
    /**
     * Bucket controls
     * @type {Array<BucketControlsInner>}
     * @memberof PermissionsDataInner
     */
    bucketControls: Array<BucketControlsInner>;
    /**
     * Created at
     * @type {Date}
     * @memberof PermissionsDataInner
...
/**
 * Check if a given object implements the PermissionsDataInner interface.
 */
export function instanceOfPermissionsDataInner(value: object): value is PermissionsDataInner {
...
export function PermissionsDataInnerFromJSON(json: any): PermissionsDataInner {
    return PermissionsDataInnerFromJSONTyped(json, false);
}

export function PermissionsDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PermissionsDataInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'bucketControls': ((json['bucket_controls'] as Array<any>).map(BucketControlsInnerFromJSON)),
        'createdAt': (new Date(json['created_at'])),
    };
}

export function PermissionsDataInnerToJSON(json: any): PermissionsDataInner {
    return PermissionsDataInnerToJSONTyped(json, false);
}

export function PermissionsDataInnerToJSONTyped(value?: PermissionsDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'bucket_controls': ((value['bucketControls'] as Array<any>).map(BucketControlsInnerToJSON)),
