 ...
 * 
 * @export
 * @interface PlanChangeReqBodyPreviousContract
 */
export interface PlanChangeReqBodyPreviousContract {
    /**
     * Resource ID
     * @type {string}
     * @memberof PlanChangeReqBodyPreviousContract
     */
    resourceId: string;
}

/**
 * Check if a given object implements the PlanChangeReqBodyPreviousContract interface.
 */
export function instanceOfPlanChangeReqBodyPreviousContract(value: object): value is PlanChangeReqBodyPreviousContract {
...
export function PlanChangeReqBodyPreviousContractFromJSON(json: any): PlanChangeReqBodyPreviousContract {
    return PlanChangeReqBodyPreviousContractFromJSONTyped(json, false);
}

export function PlanChangeReqBodyPreviousContractFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanChangeReqBodyPreviousContract {
    if (json == null) {
        return json;
    }
    return {
...
export function PlanChangeReqBodyPreviousContractToJSON(json: any): PlanChangeReqBodyPreviousContract {
    return PlanChangeReqBodyPreviousContractToJSONTyped(json, false);
}

export function PlanChangeReqBodyPreviousContractToJSONTyped(value?: PlanChangeReqBodyPreviousContract | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
