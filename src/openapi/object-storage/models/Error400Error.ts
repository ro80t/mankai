 ...
 * error 400
 * @export
 * @interface Error400Error
 */
export interface Error400Error {
    /**
     * エラーコード。
     * 
     * @type {number}
     * @memberof Error400Error
     */
    code?: number;
    /**
     * エラー発生時のメッセージ内容。
...
/**
 * Check if a given object implements the Error400Error interface.
 */
export function instanceOfError400Error(value: object): value is Error400Error {
    return true;
}

export function Error400ErrorFromJSON(json: any): Error400Error {
    return Error400ErrorFromJSONTyped(json, false);
}

export function Error400ErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Error400Error {
    if (json == null) {
        return json;
    }
    return {
...
export function Error400ErrorToJSON(json: any): Error400Error {
    return Error400ErrorToJSONTyped(json, false);
}

export function Error400ErrorToJSONTyped(value?: Error400Error | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
