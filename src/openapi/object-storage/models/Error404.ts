...
import type { Error404Error } from './Error404Error';
import {
    Error404ErrorFromJSON,
    Error404ErrorFromJSONTyped,
    Error404ErrorToJSON,
    Error404ErrorToJSONTyped,
} from './Error404Error';
...
export function Error404FromJSONTyped(json: any, ignoreDiscriminator: boolean): Error404 {
    ...
    return {
        ...
        'error': json['error'] == null ? undefined : Error404ErrorFromJSON(json['error']),
    };
}
...
export function Error404ToJSONTyped(value?: Error404 | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'error': Error404ErrorToJSON(value['error']),
    };
}
