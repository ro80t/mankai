...
import type { StatusDataStatusCode } from './StatusDataStatusCode';
import {
    StatusDataStatusCodeFromJSON,
    StatusDataStatusCodeFromJSONTyped,
    StatusDataStatusCodeToJSON,
    StatusDataStatusCodeToJSONTyped,
} from './StatusDataStatusCode';
...
export interface StatusData {
    ...
    /**
     * 
     * @type {StatusDataStatusCode}
     * @memberof StatusData
     */
    statusCode: StatusDataStatusCode;
}

/**
 * Check if a given object implements the StatusData interface.
 */
export function instanceOfStatusData(value: object): value is StatusData {
    if ((!('acceptNew' in (value as Record<string, any>)) && !('accept_new' in (value as Record<string, any>))) || ((value as Record<string, any>)['acceptNew'] === undefined && (value as Record<string, any>)['accept_new'] === undefined)) return false;
    ...
    if ((!('statusCode' in (value as Record<string, any>)) && !('status_code' in (value as Record<string, any>))) || ((value as Record<string, any>)['statusCode'] === undefined && (value as Record<string, any>)['status_code'] === undefined)) return false;
    return true;
}
...
export function StatusDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatusData {
    ...
    return {
        ...
        'acceptNew': json['accept_new'],
        'message': json['message'],
        'startedAt': (new Date(json['started_at'])),
        'statusCode': StatusDataStatusCodeFromJSON(json['status_code']),
    };
}

export function StatusDataToJSON(json: any): StatusData {
    return StatusDataToJSONTyped(json, false);
}

export function StatusDataToJSONTyped(value?: StatusData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'accept_new': value['acceptNew'],
        'message': value['message'],
        'started_at': value['startedAt'].toISOString(),
        'status_code': StatusDataStatusCodeToJSON(value['statusCode']),
    };
}
