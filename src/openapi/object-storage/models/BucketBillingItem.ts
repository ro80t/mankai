...
import type { BucketBillingItemDetail } from './BucketBillingItemDetail';
import {
    BucketBillingItemDetailFromJSON,
    BucketBillingItemDetailFromJSONTyped,
    BucketBillingItemDetailToJSON,
    BucketBillingItemDetailToJSONTyped,
} from './BucketBillingItemDetail';

/**
 * Bucket usage and charge for metering
 * @export
 * @interface BucketBillingItem
 */
export interface BucketBillingItem {
    /**
     * 集計対象の年月
     * @type {string}
     * @memberof BucketBillingItem
     */
    yearMonth: string;
    /**
     * 
     * @type {BucketBillingItemDetail}
     * @memberof BucketBillingItem
     */
    basic: BucketBillingItemDetail;
    /**
     * 
     * @type {BucketBillingItemDetail}
     * @memberof BucketBillingItem
     */
    storageUsage: BucketBillingItemDetail;
    /**
     * 
     * @type {BucketBillingItemDetail}
     * @memberof BucketBillingItem
     */
    numObjects: BucketBillingItemDetail;
    /**
     * 
     * @type {BucketBillingItemDetail}
     * @memberof BucketBillingItem
     */
    numTransactions: BucketBillingItemDetail;
    /**
     * 
     * @type {BucketBillingItemDetail}
     * @memberof BucketBillingItem
     */
    transferAmount: BucketBillingItemDetail;
}

/**
 * Check if a given object implements the BucketBillingItem interface.
 */
export function instanceOfBucketBillingItem(value: object): value is BucketBillingItem {
    ...
    if ((!('storageUsage' in (value as Record<string, any>)) && !('storage_usage' in (value as Record<string, any>))) || ((value as Record<string, any>)['storageUsage'] === undefined && (value as Record<string, any>)['storage_usage'] === undefined)) return false;
    if ((!('numObjects' in (value as Record<string, any>)) && !('num_objects' in (value as Record<string, any>))) || ((value as Record<string, any>)['numObjects'] === undefined && (value as Record<string, any>)['num_objects'] === undefined)) return false;
    if ((!('numTransactions' in (value as Record<string, any>)) && !('num_transactions' in (value as Record<string, any>))) || ((value as Record<string, any>)['numTransactions'] === undefined && (value as Record<string, any>)['num_transactions'] === undefined)) return false;
    if ((!('transferAmount' in (value as Record<string, any>)) && !('transfer_amount' in (value as Record<string, any>))) || ((value as Record<string, any>)['transferAmount'] === undefined && (value as Record<string, any>)['transfer_amount'] === undefined)) return false;
    return true;
}

export function BucketBillingItemFromJSON(json: any): BucketBillingItem {
    return BucketBillingItemFromJSONTyped(json, false);
}

export function BucketBillingItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketBillingItem {
    if (json == null) {
        return json;
    }
    return {
        ...
        'basic': BucketBillingItemDetailFromJSON(json['basic']),
        'storageUsage': BucketBillingItemDetailFromJSON(json['storage_usage']),
        'numObjects': BucketBillingItemDetailFromJSON(json['num_objects']),
        'numTransactions': BucketBillingItemDetailFromJSON(json['num_transactions']),
        'transferAmount': BucketBillingItemDetailFromJSON(json['transfer_amount']),
    };
}

export function BucketBillingItemToJSON(json: any): BucketBillingItem {
    return BucketBillingItemToJSONTyped(json, false);
}

export function BucketBillingItemToJSONTyped(value?: BucketBillingItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'basic': BucketBillingItemDetailToJSON(value['basic']),
        'storage_usage': BucketBillingItemDetailToJSON(value['storageUsage']),
        'num_objects': BucketBillingItemDetailToJSON(value['numObjects']),
        'num_transactions': BucketBillingItemDetailToJSON(value['numTransactions']),
        'transfer_amount': BucketBillingItemDetailToJSON(value['transferAmount']),
    };
}
