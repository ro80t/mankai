 ...
 */
export interface BucketUsageData {
    /**
     * 
     * @type {number}
     * @memberof BucketUsageData
     */
...
/**
 * Check if a given object implements the BucketUsageData interface.
 */
export function instanceOfBucketUsageData(value: object): value is BucketUsageData {
...
export function BucketUsageDataFromJSON(json: any): BucketUsageData {
    return BucketUsageDataFromJSONTyped(json, false);
}

export function BucketUsageDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketUsageData {
    if (json == null) {
        return json;
    }
    return {
...
export function BucketUsageDataToJSON(json: any): BucketUsageData {
    return BucketUsageDataToJSONTyped(json, false);
}

export function BucketUsageDataToJSONTyped(value?: BucketUsageData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
