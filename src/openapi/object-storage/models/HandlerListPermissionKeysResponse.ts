...
import type { PermissionKeyReadResponseBody } from './PermissionKeyReadResponseBody';
import {
    PermissionKeyReadResponseBodyFromJSON,
    PermissionKeyReadResponseBodyFromJSONTyped,
    PermissionKeyReadResponseBodyToJSON,
    PermissionKeyReadResponseBodyToJSONTyped,
} from './PermissionKeyReadResponseBody';

/**
 * 
 * @export
 * @interface HandlerListPermissionKeysResponse
 */
export interface HandlerListPermissionKeysResponse {
    /**
     * 
     * @type {Array<PermissionKeyReadResponseBody>}
     * @memberof HandlerListPermissionKeysResponse
     */
    data: Array<PermissionKeyReadResponseBody>;
}

/**
 * Check if a given object implements the HandlerListPermissionKeysResponse interface.
 */
export function instanceOfHandlerListPermissionKeysResponse(value: object): value is HandlerListPermissionKeysResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerListPermissionKeysResponseFromJSON(json: any): HandlerListPermissionKeysResponse {
    return HandlerListPermissionKeysResponseFromJSONTyped(json, false);
}

export function HandlerListPermissionKeysResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerListPermissionKeysResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PermissionKeyReadResponseBodyFromJSON)),
    };
}

export function HandlerListPermissionKeysResponseToJSON(json: any): HandlerListPermissionKeysResponse {
    return HandlerListPermissionKeysResponseToJSONTyped(json, false);
}

export function HandlerListPermissionKeysResponseToJSONTyped(value?: HandlerListPermissionKeysResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PermissionKeyReadResponseBodyToJSON)),
    };
}
