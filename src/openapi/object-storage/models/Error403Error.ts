 ...
 * error 403
 * @export
 * @interface Error403Error
 */
export interface Error403Error {
    /**
     * エラーコード。
     * 
     * @type {number}
     * @memberof Error403Error
     */
    code?: number;
    /**
     * エラー発生時のメッセージ内容。
...
/**
 * Check if a given object implements the Error403Error interface.
 */
export function instanceOfError403Error(value: object): value is Error403Error {
    return true;
}

export function Error403ErrorFromJSON(json: any): Error403Error {
    return Error403ErrorFromJSONTyped(json, false);
}

export function Error403ErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Error403Error {
    if (json == null) {
        return json;
    }
    return {
...
export function Error403ErrorToJSON(json: any): Error403Error {
    return Error403ErrorToJSONTyped(json, false);
}

export function Error403ErrorToJSONTyped(value?: Error403Error | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
