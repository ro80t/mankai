 ...
 * 
 * @export
 * @interface HandlerReadBucketReplicationResponse
 */
export interface HandlerReadBucketReplicationResponse {
    /**
     * 
     * @type {ModelReplication}
     * @memberof HandlerReadBucketReplicationResponse
     */
    data: ModelReplication;
}

/**
 * Check if a given object implements the HandlerReadBucketReplicationResponse interface.
 */
export function instanceOfHandlerReadBucketReplicationResponse(value: object): value is HandlerReadBucketReplicationResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerReadBucketReplicationResponseFromJSON(json: any): HandlerReadBucketReplicationResponse {
    return HandlerReadBucketReplicationResponseFromJSONTyped(json, false);
}

export function HandlerReadBucketReplicationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerReadBucketReplicationResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function HandlerReadBucketReplicationResponseToJSON(json: any): HandlerReadBucketReplicationResponse {
    return HandlerReadBucketReplicationResponseToJSONTyped(json, false);
}

export function HandlerReadBucketReplicationResponseToJSONTyped(value?: HandlerReadBucketReplicationResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
