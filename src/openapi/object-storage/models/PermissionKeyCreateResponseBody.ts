 ...
 * 
 * @export
 * @interface PermissionKeyCreateResponseBody
 */
export interface PermissionKeyCreateResponseBody {
    /**
     * Permission key ID
     * @type {string}
     * @memberof PermissionKeyCreateResponseBody
     */
    id: string;
    /**
...
/**
 * Check if a given object implements the PermissionKeyCreateResponseBody interface.
 */
export function instanceOfPermissionKeyCreateResponseBody(value: object): value is PermissionKeyCreateResponseBody {
...
export function PermissionKeyCreateResponseBodyFromJSON(json: any): PermissionKeyCreateResponseBody {
    return PermissionKeyCreateResponseBodyFromJSONTyped(json, false);
}

export function PermissionKeyCreateResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PermissionKeyCreateResponseBody {
    if (json == null) {
        return json;
    }
    return {
...
export function PermissionKeyCreateResponseBodyToJSON(json: any): PermissionKeyCreateResponseBody {
    return PermissionKeyCreateResponseBodyToJSONTyped(json, false);
}

export function PermissionKeyCreateResponseBodyToJSONTyped(value?: PermissionKeyCreateResponseBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
