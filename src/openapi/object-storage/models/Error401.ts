...
import type { Error401Error } from './Error401Error';
import {
    Error401ErrorFromJSON,
    Error401ErrorFromJSONTyped,
    Error401ErrorToJSON,
    Error401ErrorToJSONTyped,
} from './Error401Error';
...
export function Error401FromJSONTyped(json: any, ignoreDiscriminator: boolean): Error401 {
    if (json == null) {
        return json;
    }
    return {
        
        'error': json['error'] == null ? undefined : Error401ErrorFromJSON(json['error']),
    };
}
...
export function Error401ToJSONTyped(value?: Error401 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'error': Error401ErrorToJSON(value['error']),
    };
}
