 ...
 * 
 * @export
 * @interface HandlerUpdateBucketEncryptionRequestBody
 */
export interface HandlerUpdateBucketEncryptionRequestBody {
    /**
     * Resource ID
     * @type {string}
     * @memberof HandlerUpdateBucketEncryptionRequestBody
     */
    kmsKeyId: string;
}

/**
 * Check if a given object implements the HandlerUpdateBucketEncryptionRequestBody interface.
 */
export function instanceOfHandlerUpdateBucketEncryptionRequestBody(value: object): value is HandlerUpdateBucketEncryptionRequestBody {
...
export function HandlerUpdateBucketEncryptionRequestBodyFromJSON(json: any): HandlerUpdateBucketEncryptionRequestBody {
    return HandlerUpdateBucketEncryptionRequestBodyFromJSONTyped(json, false);
}

export function HandlerUpdateBucketEncryptionRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerUpdateBucketEncryptionRequestBody {
    if (json == null) {
        return json;
    }
    return {
...
export function HandlerUpdateBucketEncryptionRequestBodyToJSON(json: any): HandlerUpdateBucketEncryptionRequestBody {
    return HandlerUpdateBucketEncryptionRequestBodyToJSONTyped(json, false);
}

export function HandlerUpdateBucketEncryptionRequestBodyToJSONTyped(value?: HandlerUpdateBucketEncryptionRequestBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
