 ...
 * 
 * @export
 * @interface PermissionKeysDataInner
 */
export interface PermissionKeysDataInner {
    /**
     * Permission key ID
     * @type {string}
     * @memberof PermissionKeysDataInner
     */
    id: string;
    /**
     * Created at
...
/**
 * Check if a given object implements the PermissionKeysDataInner interface.
 */
export function instanceOfPermissionKeysDataInner(value: object): value is PermissionKeysDataInner {
    if (!('id' in value) || value['id'] === undefined) return false;
    if ((!('createdAt' in (value as Record<string, any>)) && !('created_at' in (value as Record<string, any>))) || ((value as Record<string, any>)['createdAt'] === undefined && (value as Record<string, any>)['created_at'] === undefined)) return false;
    return true;
}

export function PermissionKeysDataInnerFromJSON(json: any): PermissionKeysDataInner {
    return PermissionKeysDataInnerFromJSONTyped(json, false);
}

export function PermissionKeysDataInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): PermissionKeysDataInner {
    if (json == null) {
        return json;
    }
    return {
...
export function PermissionKeysDataInnerToJSON(json: any): PermissionKeysDataInner {
    return PermissionKeysDataInnerToJSONTyped(json, false);
}

export function PermissionKeysDataInnerToJSONTyped(value?: PermissionKeysDataInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
