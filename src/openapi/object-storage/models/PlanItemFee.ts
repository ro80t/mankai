 ...
 * @export
 * @interface PlanItemFee
 */
export interface PlanItemFee {
    /**
     * 
     * @type {number}
     * @memberof PlanItemFee
     */
    forMonth: number;
    /**
     * 
...
/**
 * Check if a given object implements the PlanItemFee interface.
 */
export function instanceOfPlanItemFee(value: object): value is PlanItemFee {
    if ((!('forMonth' in (value as Record<string, any>)) && !('for_month' in (value as Record<string, any>))) || ((value as Record<string, any>)['forMonth'] === undefined && (value as Record<string, any>)['for_month'] === undefined)) return false;
...
export function PlanItemFeeFromJSON(json: any): PlanItemFee {
    return PlanItemFeeFromJSONTyped(json, false);
}

export function PlanItemFeeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanItemFee {
    if (json == null) {
        return json;
    }
    return {
...
export function PlanItemFeeToJSON(json: any): PlanItemFee {
    return PlanItemFeeToJSONTyped(json, false);
}

export function PlanItemFeeToJSONTyped(value?: PlanItemFee | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
