 ...
 * data type
 * @export
 * @interface BucketQuotaData
 */
export interface BucketQuotaData {
    /**
     * 
     * @type {number}
     * @memberof BucketQuotaData
     */
...
/**
 * Check if a given object implements the BucketQuotaData interface.
 */
export function instanceOfBucketQuotaData(value: object): value is BucketQuotaData {
...
export function BucketQuotaDataFromJSON(json: any): BucketQuotaData {
    return BucketQuotaDataFromJSONTyped(json, false);
}

export function BucketQuotaDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketQuotaData {
    if (json == null) {
        return json;
    }
    return {
...
export function BucketQuotaDataToJSON(json: any): BucketQuotaData {
    return BucketQuotaDataToJSONTyped(json, false);
}

export function BucketQuotaDataToJSONTyped(value?: BucketQuotaData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
