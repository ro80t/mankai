...
import type { BucketPenaltyData } from './BucketPenaltyData';
import {
    BucketPenaltyDataFromJSON,
    BucketPenaltyDataFromJSONTyped,
    BucketPenaltyDataToJSON,
    BucketPenaltyDataToJSONTyped,
} from './BucketPenaltyData';

/**
 * Bucket penalty
 * @export
 * @interface BucketPenalty
 */
export interface BucketPenalty {
    /**
     * 
     * @type {BucketPenaltyData}
     * @memberof BucketPenalty
     */
    data: BucketPenaltyData;
}

/**
 * Check if a given object implements the BucketPenalty interface.
 */
export function instanceOfBucketPenalty(value: object): value is BucketPenalty {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function BucketPenaltyFromJSON(json: any): BucketPenalty {
    return BucketPenaltyFromJSONTyped(json, false);
}

export function BucketPenaltyFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketPenalty {
    if (json == null) {
        return json;
    }
    return {
        
        'data': BucketPenaltyDataFromJSON(json['data']),
    };
}

export function BucketPenaltyToJSON(json: any): BucketPenalty {
    return BucketPenaltyToJSONTyped(json, false);
}

export function BucketPenaltyToJSONTyped(value?: BucketPenalty | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': BucketPenaltyDataToJSON(value['data']),
    };
}
