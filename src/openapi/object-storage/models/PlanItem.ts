...
import type { PlanItemFee } from './PlanItemFee';
import {
    PlanItemFeeFromJSON,
    PlanItemFeeFromJSONTyped,
    PlanItemFeeToJSON,
    PlanItemFeeToJSONTyped,
} from './PlanItemFee';
...
/**
 * Check if a given object implements the PlanItem interface.
 */
export function instanceOfPlanItem(value: object): value is PlanItem {
...
export function PlanItemFromJSON(json: any): PlanItem {
    return PlanItemFromJSONTyped(json, false);
}

export function PlanItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanItem {
    if (json == null) {
        return json;
    }
    return {
        ...
        'fee': PlanItemFeeFromJSON(json['fee']),
    };
}

export function PlanItemToJSON(json: any): PlanItem {
    return PlanItemToJSONTyped(json, false);
}

export function PlanItemToJSONTyped(value?: PlanItem | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'fee': PlanItemFeeToJSON(value['fee']),
    };
}
