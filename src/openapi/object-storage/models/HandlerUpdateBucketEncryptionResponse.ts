 ...
 * 
 * @export
 * @interface HandlerUpdateBucketEncryptionResponse
 */
export interface HandlerUpdateBucketEncryptionResponse {
    /**
     * Resource ID
     * @type {string}
     * @memberof HandlerUpdateBucketEncryptionResponse
     */
    kmsKeyId: string;
    /**
     * Created at
...
/**
 * Check if a given object implements the HandlerUpdateBucketEncryptionResponse interface.
 */
export function instanceOfHandlerUpdateBucketEncryptionResponse(value: object): value is HandlerUpdateBucketEncryptionResponse {
    if ((!('kmsKeyId' in (value as Record<string, any>)) && !('kms_key_id' in (value as Record<string, any>))) || ((value as Record<string, any>)['kmsKeyId'] === undefined && (value as Record<string, any>)['kms_key_id'] === undefined)) return false;
    if ((!('configuredAt' in (value as Record<string, any>)) && !('configured_at' in (value as Record<string, any>))) || ((value as Record<string, any>)['configuredAt'] === undefined && (value as Record<string, any>)['configured_at'] === undefined)) return false;
    return true;
}

export function HandlerUpdateBucketEncryptionResponseFromJSON(json: any): HandlerUpdateBucketEncryptionResponse {
    return HandlerUpdateBucketEncryptionResponseFromJSONTyped(json, false);
}

export function HandlerUpdateBucketEncryptionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerUpdateBucketEncryptionResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'kmsKeyId': json['kms_key_id'],
        'configuredAt': (new Date(json['configured_at'])),
    };
}

export function HandlerUpdateBucketEncryptionResponseToJSON(json: any): HandlerUpdateBucketEncryptionResponse {
    return HandlerUpdateBucketEncryptionResponseToJSONTyped(json, false);
}

export function HandlerUpdateBucketEncryptionResponseToJSONTyped(value?: HandlerUpdateBucketEncryptionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'configured_at': value['configuredAt'].toISOString(),
    };
}
