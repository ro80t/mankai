...
import type { PermissionKeysDataInner } from './PermissionKeysDataInner';
import {
    PermissionKeysDataInnerFromJSON,
    PermissionKeysDataInnerFromJSONTyped,
    PermissionKeysDataInnerToJSON,
    PermissionKeysDataInnerToJSONTyped,
} from './PermissionKeysDataInner';
...
export interface PermissionKeys {
    /**
     * data type
     * @type {Array<PermissionKeysDataInner>}
     * @memberof PermissionKeys
     */
    data: Array<PermissionKeysDataInner>;
}

/**
 * Check if a given object implements the PermissionKeys interface.
 */
export function instanceOfPermissionKeys(value: object): value is PermissionKeys {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function PermissionKeysFromJSON(json: any): PermissionKeys {
    return PermissionKeysFromJSONTyped(json, false);
}

export function PermissionKeysFromJSONTyped(json: any, ignoreDiscriminator: boolean): PermissionKeys {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(PermissionKeysDataInnerFromJSON)),
    };
}

export function PermissionKeysToJSON(json: any): PermissionKeys {
    return PermissionKeysToJSONTyped(json, false);
}

export function PermissionKeysToJSONTyped(value?: PermissionKeys | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(PermissionKeysDataInnerToJSON)),
    };
}
