 ...
 * 
 * @export
 * @interface StatusDataStatusCode
 */
export interface StatusDataStatusCode {
    /**
     * 
     * @type {number}
     * @memberof StatusDataStatusCode
     */
    id: number;
    /**
     * 
...
/**
 * Check if a given object implements the StatusDataStatusCode interface.
 */
export function instanceOfStatusDataStatusCode(value: object): value is StatusDataStatusCode {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('status' in value) || value['status'] === undefined) return false;
    return true;
}

export function StatusDataStatusCodeFromJSON(json: any): StatusDataStatusCode {
    return StatusDataStatusCodeFromJSONTyped(json, false);
}

export function StatusDataStatusCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): StatusDataStatusCode {
    if (json == null) {
        return json;
    }
    return {
...
export function StatusDataStatusCodeToJSON(json: any): StatusDataStatusCode {
    return StatusDataStatusCodeToJSONTyped(json, false);
}

export function StatusDataStatusCodeToJSONTyped(value?: StatusDataStatusCode | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
