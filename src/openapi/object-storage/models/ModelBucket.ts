...
/**
 * Check if a given object implements the ModelBucket interface.
 */
export function instanceOfModelBucket(value: object): value is ModelBucket {
    return true;
}

export function ModelBucketFromJSON(json: any): ModelBucket {
    return ModelBucketFromJSONTyped(json, false);
}

export function ModelBucketFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelBucket {
    if (json == null) {
        return json;
    }
    return {
...
export function ModelBucketToJSON(json: any): ModelBucket {
    return ModelBucketToJSONTyped(json, false);
}

export function ModelBucketToJSONTyped(value?: ModelBucket | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
