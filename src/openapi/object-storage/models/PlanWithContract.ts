 ...
 * 
 * @export
 * @interface PlanWithContract
 */
export interface PlanWithContract {
    /**
     * 
     * @type {PlanSummary}
     * @memberof PlanWithContract
     */
    plan: PlanSummary;
    /**
     * 
...
/**
 * Check if a given object implements the PlanWithContract interface.
 */
export function instanceOfPlanWithContract(value: object): value is PlanWithContract {
    if (!('plan' in value) || value['plan'] === undefined) return false;
    if (!('contract' in value) || value['contract'] === undefined) return false;
    return true;
}

export function PlanWithContractFromJSON(json: any): PlanWithContract {
    return PlanWithContractFromJSONTyped(json, false);
}

export function PlanWithContractFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanWithContract {
    if (json == null) {
        return json;
    }
    return {
        
        'plan': PlanSummaryFromJSON(json['plan']),
        'contract': ContractSummaryFromJSON(json['contract']),
    };
}

export function PlanWithContractToJSON(json: any): PlanWithContract {
    return PlanWithContractToJSONTyped(json, false);
}

export function PlanWithContractToJSONTyped(value?: PlanWithContract | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'contract': ContractSummaryToJSON(value['contract']),
    };
}
