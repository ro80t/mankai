 ...
 * Charge information
 * @export
 * @interface BucketBillingItemDetail
 */
export interface BucketBillingItemDetail {
    /**
     * Whether billing record was found or not. `false` means that bucket was not found, bucket was owned by other accounts, or error on metering.
     * @type {boolean}
     * @memberof BucketBillingItemDetail
     */
    found: boolean;
    /**
...
/**
 * Check if a given object implements the BucketBillingItemDetail interface.
 */
export function instanceOfBucketBillingItemDetail(value: object): value is BucketBillingItemDetail {
    ...
    if ((!('isClosing' in (value as Record<string, any>)) && !('is_closing' in (value as Record<string, any>))) || ((value as Record<string, any>)['isClosing'] === undefined && (value as Record<string, any>)['is_closing'] === undefined)) return false;
    if (!('from' in value) || value['from'] === undefined) return false;
    if (!('to' in value) || value['to'] === undefined) return false;
    return true;
}

export function BucketBillingItemDetailFromJSON(json: any): BucketBillingItemDetail {
    return BucketBillingItemDetailFromJSONTyped(json, false);
}

export function BucketBillingItemDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketBillingItemDetail {
    if (json == null) {
        return json;
    }
    return {
...
export function BucketBillingItemDetailToJSON(json: any): BucketBillingItemDetail {
    return BucketBillingItemDetailToJSONTyped(json, false);
}

export function BucketBillingItemDetailToJSONTyped(value?: BucketBillingItemDetail | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
