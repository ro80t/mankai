...
import type { BucketListResponseBody } from './BucketListResponseBody';
import {
    BucketListResponseBodyFromJSON,
    BucketListResponseBodyFromJSONTyped,
    BucketListResponseBodyToJSON,
    BucketListResponseBodyToJSONTyped,
} from './BucketListResponseBody';

/**
 * 
 * @export
 * @interface HandlerListBucketReplicableTargetsResponse
 */
export interface HandlerListBucketReplicableTargetsResponse {
    /**
     * 
     * @type {Array<BucketListResponseBody>}
     * @memberof HandlerListBucketReplicableTargetsResponse
     */
    data: Array<BucketListResponseBody>;
}

/**
 * Check if a given object implements the HandlerListBucketReplicableTargetsResponse interface.
 */
export function instanceOfHandlerListBucketReplicableTargetsResponse(value: object): value is HandlerListBucketReplicableTargetsResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerListBucketReplicableTargetsResponseFromJSON(json: any): HandlerListBucketReplicableTargetsResponse {
    return HandlerListBucketReplicableTargetsResponseFromJSONTyped(json, false);
}

export function HandlerListBucketReplicableTargetsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerListBucketReplicableTargetsResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(BucketListResponseBodyFromJSON)),
    };
}

export function HandlerListBucketReplicableTargetsResponseToJSON(json: any): HandlerListBucketReplicableTargetsResponse {
    return HandlerListBucketReplicableTargetsResponseToJSONTyped(json, false);
}

export function HandlerListBucketReplicableTargetsResponseToJSONTyped(value?: HandlerListBucketReplicableTargetsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(BucketListResponseBodyToJSON)),
    };
}
