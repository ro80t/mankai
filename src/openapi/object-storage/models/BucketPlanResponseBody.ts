 ...
 * 
 * @export
 * @interface BucketPlanResponseBody
 */
export interface BucketPlanResponseBody {
    /**
     * 
     * @type {ModelPlanType}
     * @memberof BucketPlanResponseBody
     */
    type: ModelPlanType;
    /**
...
/**
 * Check if a given object implements the BucketPlanResponseBody interface.
 */
export function instanceOfBucketPlanResponseBody(value: object): value is BucketPlanResponseBody {
...
export function BucketPlanResponseBodyFromJSON(json: any): BucketPlanResponseBody {
    return BucketPlanResponseBodyFromJSONTyped(json, false);
}

export function BucketPlanResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketPlanResponseBody {
    if (json == null) {
        return json;
    }
    return {
...
export function BucketPlanResponseBodyToJSON(json: any): BucketPlanResponseBody {
    return BucketPlanResponseBodyToJSONTyped(json, false);
}

export function BucketPlanResponseBodyToJSONTyped(value?: BucketPlanResponseBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
