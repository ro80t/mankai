...
/**
 * Check if a given object implements the PermissionKey interface.
 */
export function instanceOfPermissionKey(value: object): value is PermissionKey {
    return true;
}

export function PermissionKeyFromJSON(json: any): PermissionKey {
    return PermissionKeyFromJSONTyped(json, false);
}

export function PermissionKeyFromJSONTyped(json: any, ignoreDiscriminator: boolean): PermissionKey {
    if (json == null) {
        return json;
    }
    return {
...
export function PermissionKeyToJSON(json: any): PermissionKey {
    return PermissionKeyToJSONTyped(json, false);
}

export function PermissionKeyToJSONTyped(value?: PermissionKey | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
