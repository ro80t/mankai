 ...
 * @export
 * @interface HandlerCreateBucketRequestBodyPlan
 */
export interface HandlerCreateBucketRequestBodyPlan {
    /**
     * 
     * @type {ModelPlanType}
     * @memberof HandlerCreateBucketRequestBodyPlan
     */
    type?: ModelPlanType;
    /**
...
/**
 * Check if a given object implements the HandlerCreateBucketRequestBodyPlan interface.
 */
export function instanceOfHandlerCreateBucketRequestBodyPlan(value: object): value is HandlerCreateBucketRequestBodyPlan {
    return true;
}

export function HandlerCreateBucketRequestBodyPlanFromJSON(json: any): HandlerCreateBucketRequestBodyPlan {
    return HandlerCreateBucketRequestBodyPlanFromJSONTyped(json, false);
}

export function HandlerCreateBucketRequestBodyPlanFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerCreateBucketRequestBodyPlan {
    if (json == null) {
        return json;
    }
    return {
        
        'type': json['type'] == null ? undefined : ModelPlanTypeFromJSON(json['type']),
        'serviceClassPath': json['service_class_path'] == null ? undefined : json['service_class_path'],
    };
}

export function HandlerCreateBucketRequestBodyPlanToJSON(json: any): HandlerCreateBucketRequestBodyPlan {
    return HandlerCreateBucketRequestBodyPlanToJSONTyped(json, false);
}

export function HandlerCreateBucketRequestBodyPlanToJSONTyped(value?: HandlerCreateBucketRequestBodyPlan | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
