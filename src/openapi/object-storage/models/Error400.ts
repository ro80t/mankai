...
import type { Error400Error } from './Error400Error';
import {
    Error400ErrorFromJSON,
    Error400ErrorFromJSONTyped,
    Error400ErrorToJSON,
    Error400ErrorToJSONTyped,
} from './Error400Error';
...
export function Error400FromJSONTyped(json: any, ignoreDiscriminator: boolean): Error400 {
    ...
    return {
        ...
        'error': json['error'] == null ? undefined : Error400ErrorFromJSON(json['error']),
    };
}
...
export function Error400ToJSONTyped(value?: Error400 | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'error': Error400ErrorToJSON(value['error']),
    };
}
