...
import type { AccountKeyData } from './AccountKeyData';
import {
    AccountKeyDataFromJSON,
    AccountKeyDataFromJSONTyped,
    AccountKeyDataToJSON,
    AccountKeyDataToJSONTyped,
} from './AccountKeyData';
...
/**
 * Check if a given object implements the AccountKey interface.
 */
export function instanceOfAccountKey(value: object): value is AccountKey {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function AccountKeyFromJSON(json: any): AccountKey {
    return AccountKeyFromJSONTyped(json, false);
}

export function AccountKeyFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountKey {
    if (json == null) {
        return json;
    }
    return {
        
        'data': AccountKeyDataFromJSON(json['data']),
    };
}

export function AccountKeyToJSON(json: any): AccountKey {
    return AccountKeyToJSONTyped(json, false);
}

export function AccountKeyToJSONTyped(value?: AccountKey | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': AccountKeyDataToJSON(value['data']),
    };
}
