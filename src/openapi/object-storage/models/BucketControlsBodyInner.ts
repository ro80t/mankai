 ...
 * 
 * @export
 * @interface BucketControlsBodyInner
 */
export interface BucketControlsBodyInner {
    /**
     * バケット名
     * @type {string}
     * @memberof BucketControlsBodyInner
     */
    bucketName: string;
    /**
...
/**
 * Check if a given object implements the BucketControlsBodyInner interface.
 */
export function instanceOfBucketControlsBodyInner(value: object): value is BucketControlsBodyInner {
    if ((!('bucketName' in (value as Record<string, any>)) && !('bucket_name' in (value as Record<string, any>))) || ((value as Record<string, any>)['bucketName'] === undefined && (value as Record<string, any>)['bucket_name'] === undefined)) return false;
    if ((!('canRead' in (value as Record<string, any>)) && !('can_read' in (value as Record<string, any>))) || ((value as Record<string, any>)['canRead'] === undefined && (value as Record<string, any>)['can_read'] === undefined)) return false;
    if ((!('canWrite' in (value as Record<string, any>)) && !('can_write' in (value as Record<string, any>))) || ((value as Record<string, any>)['canWrite'] === undefined && (value as Record<string, any>)['can_write'] === undefined)) return false;
    return true;
}

export function BucketControlsBodyInnerFromJSON(json: any): BucketControlsBodyInner {
    return BucketControlsBodyInnerFromJSONTyped(json, false);
}

export function BucketControlsBodyInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketControlsBodyInner {
    if (json == null) {
        return json;
    }
    return {
...
export function BucketControlsBodyInnerToJSON(json: any): BucketControlsBodyInner {
    return BucketControlsBodyInnerToJSONTyped(json, false);
}

export function BucketControlsBodyInnerToJSONTyped(value?: BucketControlsBodyInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
