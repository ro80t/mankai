 ...
 * 
 * @export
 * @interface HandlerReadPermissionKeyResponse
 */
export interface HandlerReadPermissionKeyResponse {
    /**
     * 
     * @type {PermissionKeyReadResponseBody}
     * @memberof HandlerReadPermissionKeyResponse
     */
    data: PermissionKeyReadResponseBody;
}

/**
 * Check if a given object implements the HandlerReadPermissionKeyResponse interface.
 */
export function instanceOfHandlerReadPermissionKeyResponse(value: object): value is HandlerReadPermissionKeyResponse {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function HandlerReadPermissionKeyResponseFromJSON(json: any): HandlerReadPermissionKeyResponse {
    return HandlerReadPermissionKeyResponseFromJSONTyped(json, false);
}

export function HandlerReadPermissionKeyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerReadPermissionKeyResponse {
    if (json == null) {
        return json;
    }
    return {
        
        'data': PermissionKeyReadResponseBodyFromJSON(json['data']),
    };
}

export function HandlerReadPermissionKeyResponseToJSON(json: any): HandlerReadPermissionKeyResponse {
    return HandlerReadPermissionKeyResponseToJSONTyped(json, false);
}

export function HandlerReadPermissionKeyResponseToJSONTyped(value?: HandlerReadPermissionKeyResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': PermissionKeyReadResponseBodyToJSON(value['data']),
    };
}
