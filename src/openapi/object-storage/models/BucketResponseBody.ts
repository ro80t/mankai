...
import type { BucketPlanResponseBody } from './BucketPlanResponseBody';
import {
    BucketPlanResponseBodyFromJSON,
    BucketPlanResponseBodyFromJSONTyped,
    BucketPlanResponseBodyToJSON,
    BucketPlanResponseBodyToJSONTyped,
} from './BucketPlanResponseBody';
 ...
 */
export interface BucketResponseBody {
    /**
     * 
     * @type {string}
     * @memberof BucketResponseBody
     */
    clusterId: string;
    /**
     * 
    ...
    /**
     * 
     * @type {BucketPlanResponseBody}
     * @memberof BucketResponseBody
     */
    plan: BucketPlanResponseBody;
}

/**
 * Check if a given object implements the BucketResponseBody interface.
 */
export function instanceOfBucketResponseBody(value: object): value is BucketResponseBody {
...
export function BucketResponseBodyFromJSON(json: any): BucketResponseBody {
    return BucketResponseBodyFromJSONTyped(json, false);
}

export function BucketResponseBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketResponseBody {
    if (json == null) {
        return json;
    }
    return {
        ...
        'name': json['name'],
        'plan': BucketPlanResponseBodyFromJSON(json['plan']),
    };
}

export function BucketResponseBodyToJSON(json: any): BucketResponseBody {
    return BucketResponseBodyToJSONTyped(json, false);
}

export function BucketResponseBodyToJSONTyped(value?: BucketResponseBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'name': value['name'],
        'plan': BucketPlanResponseBodyToJSON(value['plan']),
    };
}
