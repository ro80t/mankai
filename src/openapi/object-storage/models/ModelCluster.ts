...
export interface ModelCluster {
     ...
     * @type {ModelClusterPlanFamilyEnum}
     * @memberof ModelCluster
     */
    planFamily?: ModelClusterPlanFamilyEnum;
}
 ...
 * @export
 */
export const ModelClusterPlanFamilyEnum = {
    Standard: 'standard',
    Archive: 'archive'
} as const;
export type ModelClusterPlanFamilyEnum = typeof ModelClusterPlanFamilyEnum[keyof typeof ModelClusterPlanFamilyEnum];


/**
 * Check if a given object implements the ModelCluster interface.
 */
export function instanceOfModelCluster(value: object): value is ModelCluster {
    return true;
}
...
export function ModelClusterFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCluster {
    ...
    return {
        ...
        'apiZone': json['api_zone'] == null ? undefined : json['api_zone'],
        'controlPanelUrl': json['control_panel_url'] == null ? undefined : json['control_panel_url'],
        'displayNameEnUs': json['display_name_en_us'] == null ? undefined : json['display_name_en_us'],
        'displayNameJa': json['display_name_ja'] == null ? undefined : json['display_name_ja'],
        'displayName': json['display_name'] == null ? undefined : json['display_name'],
        'displayOrder': json['display_order'] == null ? undefined : json['display_order'],
        'endpointBase': json['endpoint_base'] == null ? undefined : json['endpoint_base'],
        'id': json['id'] == null ? undefined : json['id'],
        'region': json['region'] == null ? undefined : json['region'],
        's3Endpoint': json['s3_endpoint'] == null ? undefined : json['s3_endpoint'],
        's3EndpointForControlPanel': json['s3_endpoint_for_control_panel'] == null ? undefined : json['s3_endpoint_for_control_panel'],
        'storageZone': json['storage_zone'] == null ? undefined : json['storage_zone'],
        'planFamily': json['plan_family'] == null ? undefined : json['plan_family'],
    };
}

export function ModelClusterToJSON(json: any): ModelCluster {
    return ModelClusterToJSONTyped(json, false);
}

export function ModelClusterToJSONTyped(value?: ModelCluster | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
