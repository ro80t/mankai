 ...
 * @export
 */
export const ModelPlanType = {
    Standard: 'standard',
    Archive: 'archive'
} as const;
export type ModelPlanType = typeof ModelPlanType[keyof typeof ModelPlanType];


export function instanceOfModelPlanType(value: any): boolean {
    for (const key in ModelPlanType) {
        if (Object.prototype.hasOwnProperty.call(ModelPlanType, key)) {
            if (ModelPlanType[key as keyof typeof ModelPlanType] === value) {
                return true;
            }
        }
    }
...
export function ModelPlanTypeFromJSON(json: any): ModelPlanType {
    return ModelPlanTypeFromJSONTyped(json, false);
}

export function ModelPlanTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelPlanType {
    return json as ModelPlanType;
}

export function ModelPlanTypeToJSON(value?: ModelPlanType | null): any {
    return value as any;
}

export function ModelPlanTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): ModelPlanType {
    return value as ModelPlanType;
}
