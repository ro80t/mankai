...
export interface QuotaData {
     ...
     * @memberof QuotaData
     */
    numKeysPerPermission: number;
    /**
     * 
     * @type {number}
     * @memberof QuotaData
     */
    numBucketsPerPermission: number;
    /**
     * 
     * @type {number}
     * @memberof QuotaData
     */
    numObjectsPerBucket: number;
    /**
     * 
     * @type {number}
     * @memberof QuotaData
     */
    amountGibPerBucket: number;
}

/**
 * Check if a given object implements the QuotaData interface.
 */
export function instanceOfQuotaData(value: object): value is QuotaData {
    if ((!('numRootKeys' in (value as Record<string, any>)) && !('num_root_keys' in (value as Record<string, any>))) || ((value as Record<string, any>)['numRootKeys'] === undefined && (value as Record<string, any>)['num_root_keys'] === undefined)) return false;
    if ((!('numBuckets' in (value as Record<string, any>)) && !('num_buckets' in (value as Record<string, any>))) || ((value as Record<string, any>)['numBuckets'] === undefined && (value as Record<string, any>)['num_buckets'] === undefined)) return false;
    if ((!('numPermissions' in (value as Record<string, any>)) && !('num_permissions' in (value as Record<string, any>))) || ((value as Record<string, any>)['numPermissions'] === undefined && (value as Record<string, any>)['num_permissions'] === undefined)) return false;
    if ((!('numKeysPerPermission' in (value as Record<string, any>)) && !('num_keys_per_permission' in (value as Record<string, any>))) || ((value as Record<string, any>)['numKeysPerPermission'] === undefined && (value as Record<string, any>)['num_keys_per_permission'] === undefined)) return false;
    if ((!('numBucketsPerPermission' in (value as Record<string, any>)) && !('num_buckets_per_permission' in (value as Record<string, any>))) || ((value as Record<string, any>)['numBucketsPerPermission'] === undefined && (value as Record<string, any>)['num_buckets_per_permission'] === undefined)) return false;
...
export function QuotaDataFromJSON(json: any): QuotaData {
    return QuotaDataFromJSONTyped(json, false);
}

export function QuotaDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuotaData {
    if (json == null) {
        return json;
    }
    return {
        
        'numRootKeys': json['num_root_keys'],
        'numBuckets': json['num_buckets'],
        'numPermissions': json['num_permissions'],
        'numKeysPerPermission': json['num_keys_per_permission'],
        'numBucketsPerPermission': json['num_buckets_per_permission'],
        'numObjectsPerBucket': json['num_objects_per_bucket'],
        'amountGibPerBucket': json['amount_gib_per_bucket'],
    };
}

export function QuotaDataToJSON(json: any): QuotaData {
    return QuotaDataToJSONTyped(json, false);
}

export function QuotaDataToJSONTyped(value?: QuotaData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'num_root_keys': value['numRootKeys'],
        'num_buckets': value['numBuckets'],
        'num_permissions': value['numPermissions'],
        'num_keys_per_permission': value['numKeysPerPermission'],
        'num_buckets_per_permission': value['numBucketsPerPermission'],
        'num_objects_per_bucket': value['numObjectsPerBucket'],
        'amount_gib_per_bucket': value['amountGibPerBucket'],
    };
}
