 ...
 * 
 * @export
 * @interface BucketPenaltyDataAmountGibPerBucket
 */
export interface BucketPenaltyDataAmountGibPerBucket {
    /**
     * 
     * @type {number}
     * @memberof BucketPenaltyDataAmountGibPerBucket
     */
    val: number;
    /**
     * 
...
/**
 * Check if a given object implements the BucketPenaltyDataAmountGibPerBucket interface.
 */
export function instanceOfBucketPenaltyDataAmountGibPerBucket(value: object): value is BucketPenaltyDataAmountGibPerBucket {
...
export function BucketPenaltyDataAmountGibPerBucketFromJSON(json: any): BucketPenaltyDataAmountGibPerBucket {
    return BucketPenaltyDataAmountGibPerBucketFromJSONTyped(json, false);
}

export function BucketPenaltyDataAmountGibPerBucketFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketPenaltyDataAmountGibPerBucket {
    if (json == null) {
        return json;
    }
    return {
...
export function BucketPenaltyDataAmountGibPerBucketToJSON(json: any): BucketPenaltyDataAmountGibPerBucket {
    return BucketPenaltyDataAmountGibPerBucketToJSONTyped(json, false);
}

export function BucketPenaltyDataAmountGibPerBucketToJSONTyped(value?: BucketPenaltyDataAmountGibPerBucket | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
