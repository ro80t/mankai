...
import type { HandlerUpdateBucketEncryptionResponse } from './HandlerUpdateBucketEncryptionResponse';
import {
    HandlerUpdateBucketEncryptionResponseFromJSON,
    HandlerUpdateBucketEncryptionResponseFromJSONTyped,
    HandlerUpdateBucketEncryptionResponseToJSON,
    HandlerUpdateBucketEncryptionResponseToJSONTyped,
} from './HandlerUpdateBucketEncryptionResponse';

/**
 * 
 * @export
 * @interface UpdateBucketEncryption200Response
 */
export interface UpdateBucketEncryption200Response {
    /**
     * 
     * @type {HandlerUpdateBucketEncryptionResponse}
     * @memberof UpdateBucketEncryption200Response
     */
    data: HandlerUpdateBucketEncryptionResponse;
}

/**
 * Check if a given object implements the UpdateBucketEncryption200Response interface.
 */
export function instanceOfUpdateBucketEncryption200Response(value: object): value is UpdateBucketEncryption200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function UpdateBucketEncryption200ResponseFromJSON(json: any): UpdateBucketEncryption200Response {
    return UpdateBucketEncryption200ResponseFromJSONTyped(json, false);
}

export function UpdateBucketEncryption200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateBucketEncryption200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': HandlerUpdateBucketEncryptionResponseFromJSON(json['data']),
    };
}

export function UpdateBucketEncryption200ResponseToJSON(json: any): UpdateBucketEncryption200Response {
    return UpdateBucketEncryption200ResponseToJSONTyped(json, false);
}

export function UpdateBucketEncryption200ResponseToJSONTyped(value?: UpdateBucketEncryption200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': HandlerUpdateBucketEncryptionResponseToJSON(value['data']),
    };
}
