...
import type { BucketUsageData } from './BucketUsageData';
import {
    BucketUsageDataFromJSON,
    BucketUsageDataFromJSONTyped,
    BucketUsageDataToJSON,
    BucketUsageDataToJSONTyped,
} from './BucketUsageData';
...
export function BucketUsageFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketUsage {
    ...
    return {
        ...
        'data': BucketUsageDataFromJSON(json['data']),
    };
}

export function BucketUsageToJSON(json: any): BucketUsage {
    return BucketUsageToJSONTyped(json, false);
}

export function BucketUsageToJSONTyped(value?: BucketUsage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': BucketUsageDataToJSON(value['data']),
    };
}
