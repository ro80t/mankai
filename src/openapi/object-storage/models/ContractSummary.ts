...
export interface ContractSummary {
    ...
    /**
     * 
     * @type {ContractSummaryStatusEnum}
     * @memberof ContractSummary
     */
 ...
 * @export
 */
export const ContractSummaryStatusEnum = {
    Active: 'active',
    Terminated: 'terminated'
} as const;
export type ContractSummaryStatusEnum = typeof ContractSummaryStatusEnum[keyof typeof ContractSummaryStatusEnum];
