 ...
 * error 404
 * @export
 * @interface Error404Error
 */
export interface Error404Error {
    /**
     * エラーコード。
     * 
     * @type {number}
     * @memberof Error404Error
     */
    code?: number;
    /**
     * エラー発生時のメッセージ内容。
...
/**
 * Check if a given object implements the Error404Error interface.
 */
export function instanceOfError404Error(value: object): value is Error404Error {
    return true;
}

export function Error404ErrorFromJSON(json: any): Error404Error {
    return Error404ErrorFromJSONTyped(json, false);
}

export function Error404ErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Error404Error {
    if (json == null) {
        return json;
    }
    return {
...
export function Error404ErrorToJSON(json: any): Error404Error {
    return Error404ErrorToJSONTyped(json, false);
}

export function Error404ErrorToJSONTyped(value?: Error404Error | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
