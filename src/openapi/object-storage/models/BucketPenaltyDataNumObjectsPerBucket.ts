 ...
 * 
 * @export
 * @interface BucketPenaltyDataNumObjectsPerBucket
 */
export interface BucketPenaltyDataNumObjectsPerBucket {
    /**
     * 
     * @type {number}
     * @memberof BucketPenaltyDataNumObjectsPerBucket
     */
    val: number;
    /**
     * 
...
/**
 * Check if a given object implements the BucketPenaltyDataNumObjectsPerBucket interface.
 */
export function instanceOfBucketPenaltyDataNumObjectsPerBucket(value: object): value is BucketPenaltyDataNumObjectsPerBucket {
    if (!('val' in value) || value['val'] === undefined) return false;
    if (!('quota' in value) || value['quota'] === undefined) return false;
    if ((!('isApplied' in (value as Record<string, any>)) && !('is_applied' in (value as Record<string, any>))) || ((value as Record<string, any>)['isApplied'] === undefined && (value as Record<string, any>)['is_applied'] === undefined)) return false;
    return true;
}

export function BucketPenaltyDataNumObjectsPerBucketFromJSON(json: any): BucketPenaltyDataNumObjectsPerBucket {
    return BucketPenaltyDataNumObjectsPerBucketFromJSONTyped(json, false);
}

export function BucketPenaltyDataNumObjectsPerBucketFromJSONTyped(json: any, ignoreDiscriminator: boolean): BucketPenaltyDataNumObjectsPerBucket {
    if (json == null) {
        return json;
    }
    return {
...
export function BucketPenaltyDataNumObjectsPerBucketToJSON(json: any): BucketPenaltyDataNumObjectsPerBucket {
    return BucketPenaltyDataNumObjectsPerBucketToJSONTyped(json, false);
}

export function BucketPenaltyDataNumObjectsPerBucketToJSONTyped(value?: BucketPenaltyDataNumObjectsPerBucket | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
