 ...
 * 
 * @export
 * @interface HandlerReadBucketEncryptionResponse
 */
export interface HandlerReadBucketEncryptionResponse {
    /**
     * Resource ID
     * @type {string}
     * @memberof HandlerReadBucketEncryptionResponse
     */
    kmsKeyId: string;
    /**
     * Created at
...
/**
 * Check if a given object implements the HandlerReadBucketEncryptionResponse interface.
 */
export function instanceOfHandlerReadBucketEncryptionResponse(value: object): value is HandlerReadBucketEncryptionResponse {
...
export function HandlerReadBucketEncryptionResponseFromJSON(json: any): HandlerReadBucketEncryptionResponse {
    return HandlerReadBucketEncryptionResponseFromJSONTyped(json, false);
}

export function HandlerReadBucketEncryptionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): HandlerReadBucketEncryptionResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function HandlerReadBucketEncryptionResponseToJSON(json: any): HandlerReadBucketEncryptionResponse {
    return HandlerReadBucketEncryptionResponseToJSONTyped(json, false);
}

export function HandlerReadBucketEncryptionResponseToJSONTyped(value?: HandlerReadBucketEncryptionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
