...
import type { HandlerReadBucketEncryptionResponse } from './HandlerReadBucketEncryptionResponse';
import {
    HandlerReadBucketEncryptionResponseFromJSON,
    HandlerReadBucketEncryptionResponseFromJSONTyped,
    HandlerReadBucketEncryptionResponseToJSON,
    HandlerReadBucketEncryptionResponseToJSONTyped,
} from './HandlerReadBucketEncryptionResponse';

/**
 * 
 * @export
 * @interface ReadBucketEncryption200Response
 */
export interface ReadBucketEncryption200Response {
    /**
     * 
     * @type {HandlerReadBucketEncryptionResponse}
     * @memberof ReadBucketEncryption200Response
     */
    data: HandlerReadBucketEncryptionResponse;
}

/**
 * Check if a given object implements the ReadBucketEncryption200Response interface.
 */
export function instanceOfReadBucketEncryption200Response(value: object): value is ReadBucketEncryption200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ReadBucketEncryption200ResponseFromJSON(json: any): ReadBucketEncryption200Response {
    return ReadBucketEncryption200ResponseFromJSONTyped(json, false);
}

export function ReadBucketEncryption200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadBucketEncryption200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': HandlerReadBucketEncryptionResponseFromJSON(json['data']),
    };
}

export function ReadBucketEncryption200ResponseToJSON(json: any): ReadBucketEncryption200Response {
    return ReadBucketEncryption200ResponseToJSONTyped(json, false);
}

export function ReadBucketEncryption200ResponseToJSONTyped(value?: ReadBucketEncryption200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': HandlerReadBucketEncryptionResponseToJSON(value['data']),
    };
}
