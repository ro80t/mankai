...
import {
    PermissionDataFromJSON,
    PermissionDataFromJSONTyped,
    PermissionDataToJSON,
    PermissionDataToJSONTyped,
} from './PermissionData';
...
export function PermissionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Permission {
    ...
    return {
        ...
        'data': PermissionDataFromJSON(json['data']),
    };
}
...
export function PermissionToJSONTyped(value?: Permission | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': PermissionDataToJSON(value['data']),
    };
}
