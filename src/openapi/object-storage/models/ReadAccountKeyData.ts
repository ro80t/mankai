 ...
 * data type
 * @export
 * @interface ReadAccountKeyData
 */
export interface ReadAccountKeyData {
    /**
     * Access key ID
     * @type {string}
     * @memberof ReadAccountKeyData
     */
    id: string;
    /**
     * Created at
...
/**
 * Check if a given object implements the ReadAccountKeyData interface.
 */
export function instanceOfReadAccountKeyData(value: object): value is ReadAccountKeyData {
    if (!('id' in value) || value['id'] === undefined) return false;
    if ((!('createdAt' in (value as Record<string, any>)) && !('created_at' in (value as Record<string, any>))) || ((value as Record<string, any>)['createdAt'] === undefined && (value as Record<string, any>)['created_at'] === undefined)) return false;
    return true;
}

export function ReadAccountKeyDataFromJSON(json: any): ReadAccountKeyData {
    return ReadAccountKeyDataFromJSONTyped(json, false);
}

export function ReadAccountKeyDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadAccountKeyData {
    if (json == null) {
        return json;
    }
    return {
...
export function ReadAccountKeyDataToJSON(json: any): ReadAccountKeyData {
    return ReadAccountKeyDataToJSONTyped(json, false);
}

export function ReadAccountKeyDataToJSONTyped(value?: ReadAccountKeyData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
