...
import type { BucketBillingItem } from './BucketBillingItem';
import {
    BucketBillingItemFromJSON,
    BucketBillingItemFromJSONTyped,
    BucketBillingItemToJSON,
    BucketBillingItemToJSONTyped,
} from './BucketBillingItem';

/**
 * 
 * @export
 * @interface ListBucketMetering200Response
 */
export interface ListBucketMetering200Response {
    /**
     * 
     * @type {Array<BucketBillingItem>}
     * @memberof ListBucketMetering200Response
     */
    data: Array<BucketBillingItem>;
}

/**
 * Check if a given object implements the ListBucketMetering200Response interface.
 */
export function instanceOfListBucketMetering200Response(value: object): value is ListBucketMetering200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    return true;
}

export function ListBucketMetering200ResponseFromJSON(json: any): ListBucketMetering200Response {
    return ListBucketMetering200ResponseFromJSONTyped(json, false);
}

export function ListBucketMetering200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListBucketMetering200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(BucketBillingItemFromJSON)),
    };
}

export function ListBucketMetering200ResponseToJSON(json: any): ListBucketMetering200Response {
    return ListBucketMetering200ResponseToJSONTyped(json, false);
}

export function ListBucketMetering200ResponseToJSONTyped(value?: ListBucketMetering200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(BucketBillingItemToJSON)),
    };
}
